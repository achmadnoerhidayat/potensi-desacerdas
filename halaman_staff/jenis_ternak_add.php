                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_jenis_ternak.php" method="post">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Jenis Ternak</b></label>
                                        						<input type="text" class="input w-full border mt-2" 
											id="txtjenis" name="txtjenis" autocomplete="off" required placeholder="Jenis Ternak">
                                    					</div>	
									...
									<div class="mt-3">
										<label><b>Kelompok Ternak</b></label>
												...
												<?php
													$sql="select distinct(kelompok) as kel FROM tbjenis_ternak";
			       										$sql_row=mysqli_query($koneksi,$sql);
			       										while($sql_res=mysqli_fetch_assoc($sql_row))	
														{
												?>
											<option value="<?php echo $sql_res["kel"]; ?>"><?php echo $sql_res["kel"]; ?></option>
			       									<?php
			       										}
			       									?>
													</select>
