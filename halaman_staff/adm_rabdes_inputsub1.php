...
session_start();
	...
	if(isset($_POST['btnSimpan'])) {
		...
		$txtnmsub = $_POST['txtnmsub'];
		
		$data = mysqli_query($koneksi,"SELECT * FROM tbrek WHERE kode='$txtkodesub'"); 
  ...
  alert("Kode Rekening Sudah Ada!");
			...
			mysqli_query($koneksi,"INSERT INTO tbrek (kode, nama) 
								VALUES ('$txtkodesub','$txtnmsub')");
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" id="txtkodesub" name="txtkodesub" 
										required placeholder="Kode Rekening Sub" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtnmsub" name="txtnmsub" 
										required placeholder="Nama Rekening Sub" >
