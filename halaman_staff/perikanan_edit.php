...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT kd_ikan, produksi, permintaan FROM tbperikanan where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$kd_ikan=$tm_cari['kd_ikan'];
	$produksi=$tm_cari['produksi'];
	$permintaan=$tm_cari['permintaan'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Budidaya Perikanan</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="perikanan_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">

									<div class="mt-3">
										<label><b>Jenis Ikan</b></label>
										<select class="input pr-12 w-full border col-span-4" name="cbojns" id="cbojns" required>
										
										<?php
											$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_ikan");
											while ($row1 = mysqli_fetch_array($q)){
												$k_id           = $row1['kode'];
												$k_opis         = $row1['nama'];
										?>
										<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_ikan){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
										<?php
											}
										?>						
										</select>
									...
									<div class="mt-3">
										<label><b>Produksi/thn (ton)</b></label>
									...
									<div class="mt-3">
										<label><b>Permintaan/thn (ton)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpermintaan" name="txtpermintaan" value="<?php echo $permintaan; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>
