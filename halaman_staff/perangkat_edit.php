...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Perangkat Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="perangkat_edit_proses.php" method="post">
						                            ...
						                            <div class="p-5">
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																...
																<div class="mt-3">
																	<div>
																		<label><b>Upload Foto Perangkat Desa</b>&nbsp;<?php echo $file_photo; ?></label>
																...
																<div class="mt-3">
																	...
																	id="txtnm" name="txtnm" value="<?php echo $nama; ?>" 
																	autocomplete="off" required placeholder="Nama Lengkap">
						                                        </div>
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			...
																			id="txtnap" name="txtnap" value="<?php echo $nap; ?>" 
																			autocomplete="off" required placeholder="NAP">
																		</div>
																		<div class="relative mt-2">
																			<label><b>NIP</b></label>
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtnip" name="txtnip" value="<?php echo $nip; ?>" 
																			autocomplete="off" required placeholder="NIP">
																		</div>
																	</div>                                        							
						                                        </div>	
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			...
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttempat" name="txttempat" value="<?php echo $tempat_lhr; ?>" 
																			autocomplete="off" required placeholder="Tempat Lahir">
																		</div>
																		<div class="relative mt-2">
																			<label><b>Tanggal Lahir</b></label>
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttgl" name="txttgl" autocomplete="off" placeholder="Tanggal Lahir" 
																...
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			...
																			<select class="input pr-12 w-full border col-span-4" id="cbojk" name="cbojk" required>
																				<?php
																...
																<div class="mt-3">
																	...
																	<select class="input pr-12 w-full border col-span-4" name="cbojbt" id="cbojbt" required>
																				<?php
																					$q = mysqli_query($koneksi,"select kode, jabatan FROM tbjabatan_perangkat");
																					while ($row1 = mysqli_fetch_array($q)){
																						$k_id           = $row1['kode'];
																						$k_opis         = $row1['jabatan'];
																				?>
																				<option value='<?php echo $k_id; ?>' <?php if ($k_id == $id_jabatan){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
																				<?php
																					}
																				?>
																...
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<label><b>Pangkat Golongan</b></label>
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtpangkat" name="txtpangkat" value="<?php echo $pangkat; ?>" 
																			autocomplete="off" required placeholder="Pangkat Golongan">
																		</div>
																		<div class="relative mt-2">
																			<label><b>Pendidikan</b></label>
																			<select class="input pr-12 w-full border col-span-4" id="cbopendidikan" name="cbopendidikan" required>
																				<?php
																...
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			...
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtno1" name="txtno1" value="<?php echo $no_pengangkatan; ?>" 
																			autocomplete="off" required placeholder="Nomor">
																		</div>
																		<div class="relative mt-2">
																			<label><b>Tanggal Putusan Pengangkatan</b></label>
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttgl1" name="txttgl1" autocomplete="off" placeholder="Tanggal Putusan Pengangkatan" 
																			value="<?php echo $tgl_pengangkatan; ?>">
																		</div>
																	</div>                                        							
						                                        </div>	
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<label><b>Nomor</b></label>
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtno2" name="txtno2" value="<?php echo $no_berhenti; ?>" 
																			autocomplete="off" placeholder="Nomor">
																		</div>
																		<div class="relative mt-2">
																			<label><b>Tanggal Putusan Pemberhentian</b></label>
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttgl2" name="txttgl2" autocomplete="off" placeholder="Tanggal Putusan Pemberhentian" 
																			value="<?php echo $tgl_berhenti; ?>">
																		</div>
																	</div>                                        							
						                                        </div>																
																...
																<div class="mt-3">
																	...
																	<textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="3" placeholder="Keterangan" required><?php echo $keterangan; ?></textarea>
						                                        </div>
						                                    </div>
						                                </div>
						                            </div>
