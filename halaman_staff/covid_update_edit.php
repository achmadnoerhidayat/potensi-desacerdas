...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
					tgl, DATE_FORMAT(tgl,'%d/%m/%Y') AS tanggal, suspect, probable, positif, perawatan, meninggal, sembuh 
					FROM tbcovid where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);	
	$tgl=$tm_cari['tanggal'];
	$txt1=$tm_cari['suspect'];
	$txt2=$tm_cari['probable'];
	$txt3=$tm_cari['positif'];
	$txt4=$tm_cari['perawatan'];
	$txt5=$tm_cari['meninggal'];
	$txt6=$tm_cari['sembuh'];
?>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="covid_update_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
                                    <div class="mt-3">
										...
										id="txttgl" name="txttgl" autocomplete="off" required placeholder="Tanggal" value="<?php echo $tgl; ?>">
                                    </div>
									<div class="mt-3">
															<label><b>Suspect</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" value="<?php echo $txt1; ?>" autocomplete="off" required placeholder="Suspect">
                                    </div>							
									<div class="mt-3">
															<label><b>Probable</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" value="<?php echo $txt2; ?>" autocomplete="off" required placeholder="Probable">
                                    </div>
									<div class="mt-3">
															<label><b>Positif</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt3" name="txt3" value="<?php echo $txt3; ?>" autocomplete="off" required placeholder="Positif">
                                    </div>
									<div class="mt-3">
															<label><b>Perawatan</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt4" name="txt4" value="<?php echo $txt4; ?>" autocomplete="off" required placeholder="Perawatan">
                                    </div>
									<div class="mt-3">
															<label><b>Meninggal</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt5" name="txt5" value="<?php echo $txt5; ?>" autocomplete="off" required placeholder="Meninggal">
                                    </div>
									<div class="mt-3">
															<label><b>Sembuh</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt6" name="txt6" value="<?php echo $txt6; ?>" autocomplete="off" required placeholder="Sembuh">
                                    </div>
