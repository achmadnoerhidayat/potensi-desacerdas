                                        ...
                                        <table class="table" width="100%">
											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													...
													<td width="18%" class="no-border text-center">
													...
													<td width="27%" class="no-border text-center">

													</td>
													<td align="right" width="25%" class="no-border text-center">
															<div class="sm:grid grid-cols-3 gap-2">
																<div class="relative mt-2">
																	<button type="button"
																	class="button w-20 mr-2 mb-2 flex items-center justify-center border text-gray-700">
																	<i data-feather="printer" class="w-4 h-4 mr-2"></i> <a target="_blank" href="cetak_surat_keluar.php">Print</a>
																	</button>
																</div>
																<div class="relative mt-2">
																	<button type="button"
																	class="button w-20 mr-2 mb-2 flex items-center justify-center border text-gray-700">
																	 <a target="_blank" href="export_excel_surat_keluar.php">Excel</a>
																	</button>
																</div>
																<div class="relative mt-2">
																	<button type="button"
																	class="button w-20 mr-2 mb-2 flex items-center justify-center border text-gray-700">
																	 <a target="_blank" href="export_pdf_surat_keluar.php">PDF</a>
																	</button>
																</div>
															</div>
														<div class="relative mt-2">
