...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Buku Agenda Surat Masuk BPD</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form class="form-horizontal" action="surat_masuk_edit_proses.php" method="post">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Isian Table Buku Agenda Surat Masuk BPD</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txttgl" name="txttgl" placeholder="Tanggal" value="<?php echo $tanggal; ?>">
                                    </div>	
									<br>
									<div class="mt-3">
										<label><b>Surat Masuk</b></label>
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtno" name="txtno" placeholder="Nomor" value="<?php echo $nomor; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txttglsrt" name="txttglsrt" placeholder="Tanggal" value="<?php echo $tglsrt; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txttujuan" name="txttujuan" placeholder="Tujuan" value="<?php echo $tujuan; ?>">
                                    
                                        <textarea class="input w-full border mt-2" id="txtisi" name="txtisi" rows="3" 
										placeholder="Isi Singkat" required><?php echo $isi; ?></textarea>
                                    
                                        <textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="3" 
										placeholder="Keterangan" required><?php echo $ket; ?></textarea>
                                    </div>	
