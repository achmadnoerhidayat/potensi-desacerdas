...
session_start();
	...
	$id_detail = $_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT * from tbrab_detail where id='$id_detail'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$id=$tm_cari['kode_rab'];
	$txturaian=$tm_cari['uraian'];
	$txtvolume=$tm_cari['volume'];	
	$txtharga=$tm_cari['harga'];
	$txtjumlah=$tm_cari['jumlah'];		
	$txtno_anggaran=$tm_cari['no_anggaran'];		
	...
	if(isset($_POST['btndetailedit'])) {
		...
		mysqli_query($koneksi,"UPDATE tbrab_detail SET 
								uraian='$txturaian', volume='$txtvol', harga='$txtharga', jumlah='$txtjml', no_anggaran='$cbosub' WHERE id='$txtiddetail'");
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
			...
			<input type="hidden" name="txtiddetail" value="<?php echo $id_detail; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<?php
												$q = mysqli_query($koneksi,"select no_anggaran, uraian_sub FROM tbrab_sub where kode_rab='$id'");
												while ($row1 = mysqli_fetch_array($q)){
													$k_id           = $row1['no_anggaran'];
													$k_opis         = $row1['uraian_sub'];
											?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $txtno_anggaran){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
										<?php
												}
										?>
										</select>
										...
										id="txturaian" name="txturaian" placeholder="Uraian" value="<?php echo $txturaian; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtvol" name="txtvol" placeholder="Volume" value="<?php echo $txtvolume; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtharga" name="txtharga" placeholder="Harga Satuan" value="<?php echo $txtharga; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtjml" name="txtjml" placeholder="Jumlah" value="<?php echo $txtjumlah; ?>">
									</div>
									<div class="mt-3">
										<div class="relative mt-2 text-right">
											<button type="submit" name="btndetailedit" class="button text-white bg-theme-1 shadow-md mr-2">Simpan</button>
										</div>
									</div>
								</div>
