...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nama_mata_air, luas, kapasitas, kondisi, pemanfaatan, 
					tgl_input, jam_input, user_id, 
					kode, file_photo 
					FROM tbmata_air where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama_rawa=$tm_cari['nama_mata_air'];
	$luas=$tm_cari['luas'];
	$kedalaman=$tm_cari['kapasitas'];
	$kondisi=$tm_cari['kondisi'];
	$pemanfaatan=$tm_cari['pemanfaatan'];
	$file_photo=$tm_cari['file_photo'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Mata Air</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Mata Air</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<label><b>Deskripsi/Uraian/Pemanfaatan</b></label>
										...
										placeholder="Deskripsi/Uraian/Pemanfaatan" required><?php echo $pemanfaatan; ?></textarea>                                        
                                    </div>

						<div class="mt-3">
							<div>
								<label><b>Upload Foto Mata Air</b>&nbsp;
