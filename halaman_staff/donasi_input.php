...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Program Galang Dana</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_donasi.php" method="post">
<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Program Galang Dana">
                                    </div>							
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpenggalang" name="txtpenggalang" required placeholder="Penggalang Dana">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnorek" name="txtnorek" autocomplete="off" required placeholder="No. Rekening">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnmrek" name="txtnmrek" autocomplete="off" required placeholder="Atas Nama Rekening">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
