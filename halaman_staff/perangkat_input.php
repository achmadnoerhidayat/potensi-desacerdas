...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Perangkat Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_perangkat.php" method="post">
						                            ...
						                            <div class="p-5">
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																...
																<div class="mt-3">
																	<div>
																		<label><b>Upload Foto Perangkat Desa</b></label>
																...
																<div class="mt-3">
																	...
																	id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Lengkap">
						                                        </div>
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtnap" name="txtnap" autocomplete="off" required placeholder="NAP">
																		</div>
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtnip" name="txtnip" autocomplete="off" required placeholder="NIP">
																		</div>
																	</div>                                        							
						                                        </div>	
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttempat" name="txttempat" autocomplete="off" required placeholder="Tempat Lahir">
																		</div>
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttgl" name="txttgl" autocomplete="off" required placeholder="Tanggal Lahir" 
																			value="<?php echo $tgl_skr; ?>">
																		</div>
																	</div>                                        							
						                                        </div>	
																<div class="mt-3">
																...
																<div class="mt-3">
																	...
																	<?php
																		$sql="select kode, jabatan FROM tbjabatan_perangkat";
			       														$sql_row=mysqli_query($koneksi,$sql);
			       														while($sql_res=mysqli_fetch_assoc($sql_row))	
																		{
																	?>
																	<option value="<?php echo $sql_res["kode"]; ?>"><?php echo $sql_res["jabatan"]; ?></option>
			       													<?php
			       														}
			       													?>								
																	</select>
																...
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtpangkat" name="txtpangkat" autocomplete="off" required placeholder="Pangkat Golongan">
																		</div>
																		<div class="relative mt-2">
																...
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtno1" name="txtno1" autocomplete="off" required placeholder="Nomor">
																		</div>
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txttgl1" name="txttgl1" autocomplete="off" required placeholder="Tanggal Putusan Pengangkatan" 
																			value="<?php echo $tgl_skr; ?>">
																		</div>
																	</div>                                        							
						                                        </div>	
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																			id="txtno2" name="txtno2" autocomplete="off" placeholder="Nomor">
																		</div>
																		<div class="relative mt-2">
																			<input type="text" class="input pr-12 w-full border col-span-4" 
																...
																<div class="mt-3">
																	<textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="3" placeholder="Keterangan" required></textarea>
						                                        </div>
						                                    </div>
						                                </div>
						                            </div>
