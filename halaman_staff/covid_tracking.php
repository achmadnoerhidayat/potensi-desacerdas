...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Update Informasi Tracking Covid 19</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
			...
			<a href="covid_tracking_add.php">Tambah Data</a></button>
                    </div>                    
                </div>
                <!-- BEGIN: Datatable -->
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b-2 whitespace-no-wrap">Informasi Tracking</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Tanggal Bepergian</th>
                                <th class="border-b-2 whitespace-no-wrap">Lokasi Kunjungan</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Estimasi Waktu Berkunjung</th>
                        ...
                        <tbody>
							...
							<?php 
								...
								$sql = mysqli_query($koneksi,"SELECT 
									...
									nik, nama, lokasi, estimasi, id, info 
									FROM tbtracking where kode='$kd_kel'");
                            ...
                            <tr>
                                ...
                                <td class="border-b"><?php echo $tampil['info']?></td>
                                <td class="border-b text-center"><?php echo $tampil['tanggal']?></td>
                                <td class="border-b"><?php echo $tampil['lokasi']?></td>
                                <td class="border-b text-center"><?php echo $tampil['estimasi']?></td>
                                <td class="border-b text-center">
                                    <div class="flex sm:justify-center items-center">
                                        <a class="flex items-center mr-3" href="covid_tracking_edit.php?kd=<?php echo $tampil['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-theme-6" href="covid_tracking_del.php?kd=<?php echo $tampil['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
				</td>
                            </tr>
