...
<?php include "menu_lembaga01.php"; ?>
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
						<table class="table table--sm" width="100%"> 
							<tr> 
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_lembaga.php" method="post">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                ...
                                <div class="preview">
									...
									<div class="mt-3">
	                                    <div>
	                                        <label><b>Upload Foto Pengurus</b></label>
									...
									<div class="mt-3">
										...
										id="txtnmp" name="txtnmp" autocomplete="off" required placeholder="Nama Pengurus">
                                    </div>	
									<div class="mt-3">
										<div class="relative mt-2">
											<select class="input pr-12 w-full border col-span-4" name="cbojbt" id="cbojbt" required>
												<option value="">Jabatan</option>
														<?php
													$sql="select id, nm_jabatan FROM tbjabatan_lembaga";
			       										$sql_row=mysqli_query($koneksi,$sql);
			       										while($sql_res=mysqli_fetch_assoc($sql_row))	
														{
												?>
											<option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["nm_jabatan"]; ?></option>
			       									<?php
			       										}
			       									?>
											</select>
									...
									<div class="mt-3">
										<div class="sm:grid grid-cols-2 gap-2">
											<div class="relative mt-2">
												...
												id="txttgl1" name="txttgl1" autocomplete="off" required placeholder="" value="<?php echo $tgl_skr1; ?>">
											</div>
											<div class="relative mt-2">
												<label><b>Sampai</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" 
												id="txttgl2" name="txttgl2" autocomplete="off" required placeholder="" value="<?php echo $tgl_skr2; ?>">
											</div>
										</div>
									</div>									
