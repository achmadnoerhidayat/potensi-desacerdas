...
session_start();
	...
	if(isset($_POST['btnsimpan'])) {
		...
		mysqli_query($koneksi,"UPDATE tbrab 
				SET tahun='$txttahun', bidang='$txtbidang', bidang_sub='$txtbidangsub', kegiatan='$txtkeg', waktu='$txtwaktu', rincian='$txtrincian' 
				WHERE id='$txtid'");
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										required placeholder="Tahun Anggaran" value="<?php echo $tahun; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtbidang" name="txtbidang" 
										required placeholder="Bidang" value="<?php echo $bidang; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtbidangsub" name="txtbidangsub" 
										required placeholder="Sub Bidang" value="<?php echo $bidang_sub; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtkeg" name="txtkeg" 
										required placeholder="Kegiatan" value="<?php echo $kegiatan; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtwaktu" name="txtwaktu" 
										required autocomplete="off" placeholder="Waktu Pelaksanaan" value="<?php echo $waktu; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtrincian" name="txtrincian" 
										required autocomplete="off" placeholder="Output/Keluaran" value="<?php echo $rincian; ?>" >
                                    </div>	
									<div class="mt-3 center">
										<center>
											<button type="submit" name="btnsimpan" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;SIMPAN&nbsp;&nbsp;&nbsp;   </button>
											<button type="submit" name="btnsubedit" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;EDIT SUB ANGGARAN&nbsp;&nbsp;&nbsp;   </button>
											<button type="submit" name="btdetailedit" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;EDIT DETAIL ANGGARAN&nbsp;&nbsp;&nbsp;   </button>
											<button type="submit" name="btntutup" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;BATAL&nbsp;&nbsp;&nbsp;   </button>
										</center>
                                    </div>
								</div>
                            </div>
