                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="save_sampah_timbulan.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<option value="">Sumber Sampah</option>
										<?php
											$sql="select id, sumber FROM tbtimbulan_sumber";
											$sql_row=mysqli_query($koneksi,$sql);
											while($sql_res=mysqli_fetch_assoc($sql_row))	
												{
										?>
										<option value="<?php echo $sql_res["id"]; ?>"><?php echo $sql_res["sumber"]; ?></option>
										<?php
											}
										?>
										</select>
									...
									<div class="mt-3">
										...
										id="txt1" name="txt1" 
										autocomplete="off" required placeholder="Volume (liter/orang/hari)">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" 
										autocomplete="off" required placeholder="Berat (kg/orang/hari)">
                                    </div>
