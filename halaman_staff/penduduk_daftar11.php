...
<?php include "menu_penduduk02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Laporan Dusun</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
                                        ...
                                        <table class="table">
                                            <tbody>
											<form action="penduduk_daftar11_rst.php" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													<td width="34%" class="no-border">
<select class="input pr-12 w-full border col-span-4" id="txtcari" name="txtcari">
													...
													<td width="6%" class="no-border text-center">
														<button type="submit" name="tambah" class="button w-30 bg-theme-1 text-white">CARI</button>
													</td>
