...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT * FROM tbjenis_tambang where kode='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama=$tm_cari['nama'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Jenis Bahan Galian/Tambang</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="jenis_tambang_edit_proses.php" method="post">
                                ...
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Golongan</b></label>
												...
												<?php
													$q = mysqli_query($koneksi,"select distinct(kelompok) as kel FROM tbjenis_tambang");
