...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nama_bendungan, nama_sungai, panjang, luas, 
								tahun, kondisi, deskripsi, 
								nama_saluran, lebar_saluran, debit, file_photo 
								FROM tbbendungan where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama_bendungan=$tm_cari['nama_bendungan'];
	$nm_sungai=$tm_cari['nama_sungai'];
	$panjang=$tm_cari['panjang'];
	$luas=$tm_cari['luas'];
	$tahun=$tm_cari['tahun'];
	$kondisi=$tm_cari['kondisi'];
	$pemanfaatan=$tm_cari['deskripsi'];
	$nm_saluran=$tm_cari['nama_saluran'];
	$lebar=$tm_cari['lebar_saluran'];
	$debit=$tm_cari['debit'];
	$file_photo=$tm_cari['file_photo'];
?>
...
<?php include "menu_bendungan.php"; ?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Bendungan/Waduk</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Bendungan/Waduk</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="bendungan_edit_proses.php" method="post">
								<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>

                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Nama Bendungan</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" value="<?php echo $nama_bendungan; ?>">
                                    </div>	
									<div class="mt-3">
										<label><b>Nama Sungai</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnms" name="txtnms" value="<?php echo $nm_sungai; ?>">
                                    </div>
									
										<div class="mt-3">
											<div class="sm:grid grid-cols-3 gap-2">
												<div class="relative mt-2">
													<label><b>Panjang (m)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtp" name="txtp" value="<?php echo $panjang; ?>">
												</div>
												<div class="relative mt-2">
													<label><b>Luas Area (ha)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtluas" name="txtluas" value="<?php echo $luas; ?>">
												</div>
												<div class="relative mt-2">
													<label><b>Tahun Pembuatan</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txttahun" name="txttahun" value="<?php echo $tahun; ?>">
												</div>
											</div>
										</div>
										...
										<div class="mt-3">
													...
													<label><b>Kondisi Bendungan</b></label>
													<select class="input pr-12 w-full border col-span-4" id="cbokondisi" name="cbokondisi" required>
														<option value="">Kondisi Bendungan</option>
															<?php
													$q = mysqli_query($koneksi,"select kode, kondisi FROM tbkondisi_sungai");
													while ($row1 = mysqli_fetch_array($q)){
														$k_id           = $row1['kondisi'];
														$k_opis         = $row1['kondisi'];
												?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kondisi){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
												<?php
													}
												?>		
													</select>
									...
									<div class="mt-3">
																		<label><b>Deskripsi/Uraian/Pemanfaatan</b></label>
										<textarea class="input w-full border mt-2" id="txtpotensi" name="txtpotensi" rows="4"><?php echo $pemanfaatan; ?></textarea>                                        
                                    </div>

						<div class="mt-3">
							<div>
								<label><b>Upload Foto Bendungan</b>&nbsp;
								...
								<label>*Tipe File PNG,JPEG, Ukuran Maksimum 5Mb</label>
									...
									<div class="mt-3">
										<label><b>Nama Saluran</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnmsal" name="txtnmsal" value="<?php echo $nm_saluran; ?>">
                                    </div>

										<div class="mt-3">
											<div class="sm:grid grid-cols-2 gap-2">
												<div class="relative mt-2">
													<label><b>Lebar Saluran (m)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txt1" name="txt1" value="<?php echo $lebar; ?>" >
												</div>
												<div class="relative mt-2">
													<label><b>Debit Saluran (m3/det)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtdebit" name="txtdebit" value="<?php echo $debit; ?>" >
												</div>
