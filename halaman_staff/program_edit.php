...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Program Desa</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Program Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="profil_program_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">

									<div class="mt-3">
										<label><b>Upload Gambar Program Desa</b>&nbsp;<?php echo $file_photo; ?></label>
									...
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" value="<?php echo $nm_program; ?>" placeholder="Nama Program Desa">

										<select class="input w-full border mt-2" name="cbokat" id="cbokat" required>
										<option value="">Kategori Program Desa</option>
										<?php
													$q = mysqli_query($koneksi,"select kode, nama FROM tbkategori_program");
										...
										<select class="input w-full border mt-2" name="cbostatus" id="cbostatus" required>
										<option value="">Status</option>
										<?php
													$q = mysqli_query($koneksi,"select kode, nama FROM tbstatus_program");
													while ($row1 = mysqli_fetch_array($q)){
														$k_id           = $row1['kode'];
														$k_opis         = $row1['nama'];
												?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_status){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
												<?php
													}
												?>
										</select>                                        

										<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="4" 
										placeholder="Deskripsi" required><?php echo $deskripsi; ?></textarea>                                        
                                    </div>
