...
<form class="form-horizontal" enctype="multipart/form-data" action="umkm_edit02.php" method="post">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                ...
                                <div class="preview">
										<div class="mt-3">
											<div>
												<label><b>Upload Surat Keterangan Domisili</b>&nbsp;<?php echo $file_berkas1;?></label>
												<input type="file" id="id-input-file-1" name="id-input-file-1" class="input w-full border mt-2" onchange="return validasiFile()"  />
										...
										<div class="mt-3">
											<div>
												<label><b>Upload Surat Izin Usaha</b>&nbsp;<?php echo $file_berkas2;?></label>
												<input type="file" id="id-input-file-2" name="id-input-file-2" class="input w-full border mt-2" onchange="return validasiFile1()" />
												<label>*Tipe File PDF, DOCX, XLS, Ukuran Maksimal 15Mb</label>
											</div>
										</div>
										<br>
										<div class="mt-3">
											<div>
												<label><b>Upload KTP</b>&nbsp;<?php echo $file_berkas3;?></label>
												<input type="file" id="id-input-file-3" name="id-input-file-3" class="input w-full border mt-2" onchange="return validasiFile2()" />
												<label>*Tipe File PDF, DOCX, XLS, Ukuran Maksimal 15Mb</label>
											</div>
										</div>
