...
session_start();
	...
	$id = $_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT kd_donasi, nama, jumlah, tanggal, bank, norek, nmrek, mode, 
									DATE_FORMAT(tanggal,'%d/%m/%Y') AS tgl 
									FROM tbdonasi_pemberi where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$kd_donasi=$tm_cari['kd_donasi'];
	$nama=$tm_cari['nama'];
	$jumlah=$tm_cari['jumlah'];
	$tanggal=$tm_cari['tgl'];
	$bank1=$tm_cari['bank'];	
	$norek1=$tm_cari['norek'];
	$nmrek=$tm_cari['nmrek'];	
	$mode=$tm_cari['mode'];
	
	$cari_kd=mysqli_query($koneksi,"SELECT kd_donasi, nm_donasi, penggalang, norek, nm_rek, bank, keterangan, kode, tgl_input, jam_input, user_id FROM tbdonasi where kd_donasi='$kd_donasi'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nm_donasi=$tm_cari['nm_donasi'];
	$penggalang=$tm_cari['penggalang'];
	$norek=$tm_cari['norek'];
	$nm_rek=$tm_cari['nm_rek'];
	$bank=$tm_cari['bank'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<a href="" class="">Donasi</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Informasi Program Galang Dana</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                             ...
                             <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" value="<?php echo $nm_donasi; ?>" disabled>
                                    </div>							
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpenggalang" name="txtpenggalang" value="<?php echo $penggalang; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnorek" name="txtnorek" value="<?php echo $norek; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnmrek" name="txtnmrek" value="<?php echo $nm_rek; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbank" name="txtbank" value="<?php echo $bank; ?>" disabled>
                                    </div>
                ...
                <!-- BEGIN: Input -->
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="donasi_pemberi_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
<input type="hidden" name="txtkd" value="<?php echo $kd_donasi; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Nama</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" value="<?php echo $nama; ?>" autocomplete="off" placeholder="">
                                    </div>							
									<div class="mt-3">
										<label><b>Jumlah Donasi</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtjml" name="txtjml" value="<?php echo $jumlah; ?>" autocomplete="off" placeholder="Jumlah Donasi">
                                    </div>
									<div class="mt-3">
										<label><b>Tanggal</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txttgl" name="txttgl" value="<?php echo $tanggal; ?>" autocomplete="off" placeholder="Tanggal">
                                    </div>
									<div class="mt-3">
										<label><b>Bank</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbank" name="txtbank" value="<?php echo $bank1; ?>" autocomplete="off" placeholder="Bank">
                                    </div>
									<div class="mt-3">
										<label><b>Rekening Atas Nama</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnmrek" name="txtnmrek" value="<?php echo $nmrek; ?>" autocomplete="off" placeholder="Rekening Atas Nama">
                                    </div>
									<div class="mt-3">
										<label><b>Nomor Rekening</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnorek" name="txtnorek" value="<?php echo $norek1; ?>" autocomplete="off" placeholder="Nomor Rekening">
                                    </div>
									<div class="mt-3">
										<label><b>Mode Transfer</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtmode" name="txtmode" value="<?php echo $mode; ?>" placeholder="Mode Transfer">
                                    </div>
