                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_pertambangan.php" method="post">
					...
					<div class="mt-3">
													<select class="input pr-12 w-full border col-span-4" name="cbojns" id="cbojns" required>
														<option value="">Jenis Bahan Galian</option>
																			<?php
																				$sql="select kode, nama FROM tbjenis_tambang";
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Luas Sebaran (m2)" 
												id="txtluas" name="txtluas" autocomplete="off" required>
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Produksi (ton)" 
												id="txtton" name="txtton" autocomplete="off" required>
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Konversi/Jenis Lahan" 
												id="txtlahan" name="txtlahan" autocomplete="off" required>
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Sistem Penambangan, contoh : Tambang Terbuka, Open Pit, dll.." 
												id="txtsistem" name="txtsistem" autocomplete="off" required>
											</div>
										</div>
