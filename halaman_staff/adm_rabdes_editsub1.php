...
session_start();
	...
	if(isset($_POST['btnSimpan'])) {
		...
		$txtkodeawal = $_POST['txtkodeawal'];
		$txtkodeakhir = $_POST['txtkodeakhir'];
		$txtnm = $_POST['txtnm'];

		
		mysqli_query($koneksi,"UPDATE tbrek SET nama='$txtnm' WHERE kode='$txtkodeawal'");			
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Rancangan APBDes</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<div class="text-xs text-theme-41"><?php include "titel_status.php"; ?></div>
			...
			<input type="hidden" name="txtkodeawal" value="<?php echo $kode; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" id="txtkodeakhir" name="txtkodeakhir" 
										disabled value="<?php echo $kode; ?>" >

                                        <input type="text" class="input w-full border mt-2" id="txtnm" name="txtnm" 
										value="<?php echo $nama_rek; ?>" >
                                    </div>	
