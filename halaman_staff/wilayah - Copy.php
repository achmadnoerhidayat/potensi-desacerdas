                ...
                <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
						<button class="button text-white bg-theme-1 shadow-md mr-2">
							<a href="wilayah_add.php?kdkel=<?php echo $kd_kel; ?>">Tambah Wilayah</a>
						</button>
                    </div>                    
                </div>
                <!-- BEGIN: Datatable -->
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b-2 whitespace-no-wrap">Nama Dukuh/Dusun</th>
                                <th class="border-b-2 whitespace-no-wrap">Jumlah RT</th>
                                <th class="border-b-2 whitespace-no-wrap">Luas Wilayah</th>
                                <th class="border-b-2 whitespace-no-wrap">Persentase</th>
                        ...
                        <tbody>
							...
							<?php 
								...
								$sql = mysqli_query($koneksi,"SELECT 
															id_dukuh, nm_dukuh, jumlah_rt, jumlah_jiwa, luas, persentase, deskripsi_wilayah, file_photo 
															FROM tbdukuh 
															WHERE kode='$kd_kel'");
                            ...
                            <tr>
                                <td class="border-b"><?php echo $tampil['deskripsi_wilayah']?></td>
                                <td class="border-b"><?php echo $tampil['nm_dukuh']?></td>
                                <td class="border-b text-center"><?php echo $tampil['jumlah_rt']?></td>
                                ...
                                <td class="border-b text-center">
                                    <div class="flex sm:justify-center items-center">
                                        <a class="flex items-center mr-3" href="wilayah_edit.php?kd=<?php echo $tampil['id_dukuh']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-theme-6" href="wilayah_del.php?kd=<?php echo $tampil['id_dukuh']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
									</td>
                            </tr>
