...
<?php include "menu_lembaga02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Lembaga</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <div class="pos intro-y grid grid-cols-12 gap-5 ">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="post intro-y overflow-hidden box mt-8">
                            <div class="post__tabs nav-tabs flex flex-col sm:flex-row bg-gray-200 text-gray-600">
                                <a title="Lembaga Desa" data-toggle="tab" data-target="#content" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center active">  Lembaga </a>
                                <a title="Wewenang dan Tugas Lembaga Desa" data-toggle="tab" data-target="#meta-title" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center"> Wewenang/Tugas </a>
                                <a title="Struktur Organisasi Lembaga Desa" data-toggle="tab" data-target="#keywords" href="javascript:;" class="tooltip w-full sm:w-50 py-4 text-center flex justify-center items-center">  Struktur Organisasi </a>
                            </div>
                            ...
                            <div class="post__content tab-content">
									...
									<div class="preview">
										...
										<div class="mt-3">
											<div class="relative mt-2">
												...
												<input type="text" class="input pr-12 w-full border col-span-4" id="txtnm" name="txtnm" value="<?php echo $nm_lembaga; ?>" disabled>
											</div>
										</div>
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Kategori Lembaga</b></label>
												<select class="input pr-12 w-full border col-span-4" name="cbokat" id="cbokat" disabled>
													<option value="">Kategori Lembaga</option>
												<?php
													$q = mysqli_query($koneksi,"select id, nm_kategori FROM tbkategori_lembaga");
													while ($row1 = mysqli_fetch_array($q)){
														$k_id           = $row1['id'];
														$k_opis         = $row1['nm_kategori'];
												?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_kategori){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
												<?php
													}
												?>
												</select>
								...
								<div class="tab-content__pane p-5" id="meta-title">
									<div class="mt-3">
										<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="6" disabled><?php echo $wewenang; ?></textarea>                                        
                                    </div>
								</div>
					...
					<label><b>Nama Pengurus</b></label>
										...
										id="txtnmp" name="txtnmp" value="<?php echo $nm_pengurus; ?>" disabled>
                                    </div>	
									<div class="mt-3">
										<label><b>Jabatan</b></label>
										<div class="relative mt-2">
											<select class="input pr-12 w-full border col-span-4" name="cbojbt" id="cbojbt" disabled>
									...
									<div class="mt-3">
										<div class="sm:grid grid-cols-2 gap-2">
											<div class="relative mt-2">
												...
												id="txttgl1" name="txttgl1" value="<?php echo $tgl1; ?>" disabled>
											</div>
											<div class="relative mt-2">
												<label><b>Sampai</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" 
												id="txttgl2" name="txttgl2" value="<?php echo $tgl2; ?>" disabled>
											</div>
										</div>
									</div>									
								</div>
