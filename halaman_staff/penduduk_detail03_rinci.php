...
<?php include "menu_penduduk02.php"; ?>
	...
	<center>
		<font size="3"><b>Laporan Kependudukan Berdasarkan Kelompok Usia</b></font>
		<br>
		<font size="2"><b>DUSUN <?php echo $nm_dukuh; ?></b></font>
		<br>&nbsp;
	</center>
...
<input type="hidden" name="cbodukuh" value="<?php echo $id_dukuh; ?>"/>
                                                ...
                                                <tr valign="top" class="">
                                                    	...
                                                    	<td width="10%" class="no-border text-center">
															...
															<a href="report03_dtl.php?sdukuh=<?php echo $id_dukuh; ?>" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Download&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a target="_blank" href="export_excel03_dtl.php?sdukuh=<?php echo $id_dukuh; ?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export Excel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a href="cetak03_dtl.php?sdukuh=<?php echo $id_dukuh; ?>" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                </tr>
                                            </tbody>
...
<table class="table"> 
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													$result = mysqli_query($koneksi,"SELECT * FROM tbpenduduk where kode='$kd_kel' and id_dukuh='$id_dukuh'");
												}
												...
												if(isset($_POST['tambah'])){	
													...
													$query = mysqli_query($koneksi,"select *, DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal from tbpenduduk 
													where kode='$kd_kel' and id_dukuh='$id_dukuh' LIMIT $mulai, $halaman")or die(mysql_error);
												}
												$no =$mulai+1;
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border">
																<a href="penduduk_del.php?txtid=<?php echo $data['id']?>&txtform=3" 
