...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									kd_tumbuhan, luas_tanam, luas_panen, produksi, id, produktivitas FROM tbpertanian where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$kd_tumbuhan=$tm_cari['kd_tumbuhan'];
	$luas_tanam=$tm_cari['luas_tanam'];
	$luas_panen=$tm_cari['luas_panen'];
	$produksi=$tm_cari['produksi'];
	$produktivitas=$tm_cari['produktivitas'];
?>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="pangan_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Jenis Tanaman Pangan</b></label>
										<select class="input pr-12 w-full border col-span-4" id="cbojenis" name="cbojenis" required>
										<option value=""></option>
										<?php
													$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_tanaman where kelompok='Tanaman Palawija'");
													while ($row1 = mysqli_fetch_array($q)){
														$k_id           = $row1['kode'];
														$k_opis         = $row1['nama'];
												?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_tumbuhan){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
												<?php
													}
												?>
										</select>
									...
									<div class="mt-3">
										<label><b>Luas Tanam (ha)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtltanam" name="txtltanam" value="<?php echo $luas_tanam; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>	
									<div class="mt-3">
										<label><b>Luas Panen (ha)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlpanen" name="txtlpanen" value="<?php echo $luas_panen; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Jumlah Produksi (ton)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtproduksi" name="txtproduksi" value="<?php echo $produksi; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Jumlah produktivitas (ton/ha)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtproduktivitas" name="txtproduktivitas" value="<?php echo $produktivitas; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>
