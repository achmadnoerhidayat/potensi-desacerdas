...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Buku Agenda Surat Masuk BPD</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txttgl" name="txttgl" disabled value="<?php echo $tanggal; ?>">
                                    </div>	
									<br>
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtno" name="txtno" disabled value="<?php echo $nomor; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txttglsrt" name="txttglsrt" disabled value="<?php echo $tglsrt; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txttujuan" name="txttujuan" disabled value="<?php echo $tujuan; ?>">
                                    
                                        <textarea class="input w-full border mt-2" id="txtisi" name="txtisi" rows="3" 
										disabled><?php echo $isi; ?></textarea>
                                    
                                        <textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="3" 
										disabled><?php echo $ket; ?></textarea>
                                    </div>	
