...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									nm_dukuh, jumlah_rt, jumlah_jiwa, luas, persentase, deskripsi_wilayah, file_photo 
									FROM tbdukuh 
									WHERE id_dukuh='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$deskripsi_wilayah=$tm_cari['deskripsi_wilayah'];
	$jumlah_rt=$tm_cari['jumlah_rt'];
	$jumlah_jiwa=$tm_cari['jumlah_jiwa'];
	$luas=$tm_cari['luas'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Wilayah</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form class="form-horizontal" enctype="multipart/form-data" action="wilayah_edit_proses.php" method="post">
						                                ...
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																<div class="mt-3">
																	...
																	<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" placeholder="Deskripsi" required><?php echo $deskripsi_wilayah; ?></textarea>
						                                        </div>
						                                    </div>
						                                </div>
						                            </div>
						                                    ...
						                                    <div class="col-span-12 xl:col-span-12">
																<div class="mt-3">
																	...
																	<select class="input pr-12 w-full border col-span-4" name="cbodukuh" id="cbodukuh" disabled>
																		...
																		?>
																	<option value='<?php echo $k_id; ?>' <?php if ($k_id == $id){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
																		<?php
																			}
																		?>					
																	</select>
																...
																<div class="mt-3">
																	<label><b>Jumlah RT</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtrt" name="txtrt" value="<?php echo $jumlah_rt; ?>" autocomplete="off" required placeholder="Jumlah RT">
						                                        </div>
																<div class="mt-3">
																	<label><b>Luas Wilayah (ha)</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtluas" name="txtluas" value="<?php echo $luas; ?>" autocomplete="off" required placeholder="Luas Wilayah (ha)">
						                                        </div>
																<div class="mt-3">
																	<label><b>Persentase %</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtpersen" name="txtpersen" value="<?php echo $persentase; ?>" autocomplete="off" required placeholder="Persentase %">
						                                        </div>	
