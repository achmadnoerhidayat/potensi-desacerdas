...
<form class="form-horizontal" action="penduduk_edit02.php" method="post">
                                ...
                                <div class="preview">
									<div class="mt-3">
											<div class="relative mt-2">
												...
												id="txtkk" name="txtkk" autocomplete="off" value="<?php echo $txtkk; ?>" >
											</div>
										</div>
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="NIK" 
												id="txtnik" name="txtnik" autocomplete="off" value="<?php echo $txtnik; ?>" >
											</div>
										</div>							
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Nama Lengkap" 
												id="txtnm" name="txtnm" autocomplete="off" value="<?php echo $txtnm; ?>" >
											</div>
										</div>
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Tempat Lahir" 
												id="txttempatlhr" name="txttempatlhr" autocomplete="off" value="<?php echo $txttempatlhr; ?>" >
											</div>
										</div>
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Tanggal Lahir" 
												id="txttgllahir" name="txtgllahir" autocomplete="off" required value="<?php echo $txtgllahir; ?>" >
											</div>
										</div>
										<div class="mt-3">
										...
										<div class="mt-3">
											<div class="relative mt-2">
												...
												id="txtalamat" name="txtalamat" autocomplete="off" value="<?php echo $txtalamat; ?>" >
											</div>
										</div>
										<div class="mt-3">
											<div class="sm:grid grid-cols-2 gap-2">
										...
										<div class="mt-3">
											<div class="sm:grid grid-cols-2 gap-2">
												...
												id="txtrt" name="txtrt" autocomplete="off" value="<?php echo $txtrt; ?>">
												</div>
												<div class="relative mt-2">
													<input class="input pr-12 w-full border col-span-4" placeholder="RW" 
												id="txtrw" name="txtrw" autocomplete="off" value="<?php echo $txtrw; ?>">
												</div>
											</div>
										</div>
										<div class="mt-3">
