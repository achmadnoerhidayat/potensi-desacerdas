...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT nama_rawa, luas, kedalaman, kondisi, pemanfaatan, 
					tgl_input, jam_input, user_id, 
					kode, file_photo 
					FROM tbrawa where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama_rawa=$tm_cari['nama_rawa'];
	$luas=$tm_cari['luas'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<a href="" class="">Rawa</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Rawa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="rawa_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Nama Rawa</b></label>
