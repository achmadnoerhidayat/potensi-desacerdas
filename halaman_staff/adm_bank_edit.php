...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									kode, tahun, bulan, tgl_trx, uraian_trx, setoran, bunga, penarikan, pajak, adm, 
									DATE_FORMAT(tgl_trx,'%d/%m/%Y') AS tgl, file_photo 
									FROM tbbank 
									where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$tahun=$tm_cari['tahun'];
	$bulan=$tm_cari['bulan'];
	$tgl=$tm_cari['tgl'];
	$uraian=$tm_cari['uraian_trx'];
	$txt1=$tm_cari['setoran'];
	$txt2=$tm_cari['bunga'];
	$txt3=$tm_cari['penarikan'];
	$txt4=$tm_cari['pajak'];
	$txt5=$tm_cari['adm'];
	$file_photo=$tm_cari['file_photo'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Buku Bank</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="adm_bank_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										value="<?php echo $tahun; ?>" required autocomplete="off" placeholder="Tahun Anggaran" >
										<select class="input w-full border mt-2" name="cbobln" id="cbobln" required>
										<option value="">Bulan</option>
										<?php
																	$q = mysqli_query($koneksi,"select bulan FROM tbbulan order by id");
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Isian Table Buku Bank</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txttgl" name="txttgl" placeholder="Tanggal Transaksi" value="<?php echo $tgl; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txturaian" name="txturaian" placeholder="Uraian Transaksi" value="<?php echo $uraian; ?>">
                                    </div>									
									<br>								
									<div class="mt-3">
										<label><b>Surat Keluar</b>&nbsp;
									...
									<br>
									<div class="mt-3">
										<label><b>Pemasukan</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" placeholder="Setoran" value="<?php echo $txt1; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" placeholder="Bunga Bank" value="<?php echo $txt2; ?>">
                                    </div>	
									<br>
									<div class="mt-3">
										<label><b>Pengeluaran</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt3" name="txt3" placeholder="Penarikan" value="<?php echo $txt3; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt4" name="txt4" placeholder="Pajak" value="<?php echo $txt4; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt5" name="txt5" placeholder="Administrasi Bank" value="<?php echo $txt5; ?>">
                                    </div>									
