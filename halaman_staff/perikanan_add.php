                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_perikanan.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<?php
											$sql="select kode, nama FROM tbjenis_ikan";
									...
									<div class="mt-3">
										...
										autocomplete="off" required placeholder="Produksi/thn (ton)">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpermintaan" name="txtpermintaan" 
										autocomplete="off" required placeholder="Permintaan/thn (ton)">
                                    </div>
