...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input User</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">									
										...
										id="txtnip" name="txtnip" autocomplete="off" required placeholder="NIK">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Lengkap">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtuser" name="txtuser" autocomplete="off" required placeholder="Username">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtemail" name="txtemail" autocomplete="off" required placeholder="Email">

										<select class="input w-full border mt-2" name="cbolevel" id="cbolevel" required>
										<option value="">Role/Hak Akses</option>
										<?php
													$sql="select id, nama_level FROM tbakses where id<>'1'";
										...
										id="txtpwd" name="txtpwd" autocomplete="off" required placeholder="Password">

										<input type="password" class="input w-full border mt-2" 
										id="txtpwdk" name="txtpwdk" autocomplete="off" required placeholder="Ulangi Password">
