...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<a href="" class="breadcrumb--active">Input Data RT</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_rt.php" method="post">
                            ...
                            <div class="p-5" id="input">
								...
								<div class="mt-3">
									...
									<div class="mt-3">
											...
											id="txtrt" name="txtrt" autocomplete="off" required placeholder="RT">
                                    					</div>	
