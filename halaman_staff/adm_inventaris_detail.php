...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Buku Inventaris Hasil Pembangunan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txttgl" name="txttgl" disabled value="<?php echo $tgl_skr; ?>">
                                    <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" disabled value="<?php echo $nama; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtvol" name="txtvol" disabled value="<?php echo $vol; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbiaya" name="txtbiaya" disabled value="<?php echo $biaya; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlok" name="txtlok" disabled value="<?php echo $lok; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtket" name="txtket" disabled value="<?php echo $keterangan; ?>">
                                    </div>
