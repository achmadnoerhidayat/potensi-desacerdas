...
<form class="form-horizontal" enctype="multipart/form-data" action="save_umkm.php" method="post">
							...
							<input type="hidden" name="txtberkas1_nm" value="<?php echo $name1; ?>"/>
							<input type="hidden" name="txtberkas1_foto" value="<?php echo $folder1; ?>"/>

							
							<input type="hidden" name="txtberkas2_nm" value="<?php echo $name2; ?>"/>
							<input type="hidden" name="txtberkas2_foto" value="<?php echo $folder2; ?>"/>

							
							<input type="hidden" name="txtberkas3_nm" value="<?php echo $name3; ?>"/>
							<input type="hidden" name="txtberkas3_foto" value="<?php echo $folder3; ?>"/>
...
var uploadField = document.getElementById("id-input-file-4");
