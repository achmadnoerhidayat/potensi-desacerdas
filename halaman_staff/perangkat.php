...
<?php include "menu_profil10.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Perangkat Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													<td width="80%" class="no-border">
														...
														placeholder="Nama/NAP/NIP" id="txtcari" name="txtcari">               
													</td>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
							...
							<a href="perangkat_input.php">Tambah Perangkat Desa</a>
						</button><br>&nbsp;
										...
										<table class="table table--sm" width="100%"> 
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													if ($txtcari<>'') {
														$result = mysqli_query($koneksi,"SELECT * FROM tbperangkat WHERE kode='$kd_kel' and 
																						(nama like '%$txtcari%' OR 
																						nap='$txtcari' OR nip='$txtcari')");
													}
													if ($txtcari=='') {
														$result = mysqli_query($koneksi,"SELECT * FROM tbperangkat WHERE kode='$kd_kel'");
													}
												} else {
													$result = mysqli_query($koneksi,"SELECT * FROM tbperangkat WHERE kode='$kd_kel'");
												}
												...
												if(isset($_POST['tambah'])){	
													...
													if ($txtcari=='') {
														$query = mysqli_query($koneksi,"SELECT * FROM tbperangkat WHERE kode='$kd_kel' 
																						LIMIT $mulai, $halaman")or die(mysql_error);													
													}
												} else {
													$query = mysqli_query($koneksi,"SELECT * FROM tbperangkat WHERE kode='$kd_kel' 
