                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="save_pangan.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<option value="">Jenis Tanaman Pangan</option>
										<?php
											$sql="select kode, nama FROM tbjenis_tanaman where kelompok='Tanaman Palawija'";
										...
										id="txtltanam" name="txtltanam" 
										autocomplete="off" required placeholder="Luas Tanam (ha)">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtlpanen" name="txtlpanen" 
										autocomplete="off" required placeholder="Luas Panen (ha)">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtproduksi" name="txtproduksi" 
										autocomplete="off" required placeholder="Jumlah Produksi (ton)">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtproduktivitas" name="txtproduktivitas" 
										autocomplete="off" required placeholder="Jumlah produktivitas (ton/ha)">
                                    </div>
