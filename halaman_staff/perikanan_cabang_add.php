                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_perikanan_cabang.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<option value="">Cabang Usaha</option>
										<?php
																				$sql="select kode, nama FROM tbcabang_ikan";
									...
									<div class="mt-3">
										...
										id="txtpotensi" name="txtpotensi" 
										autocomplete="off" required placeholder="Potensi (ton)">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpemanfaatan" name="txtpemanfaatan" 
										autocomplete="off" required placeholder="Pemanfaatan (ton)">
                                    </div>
