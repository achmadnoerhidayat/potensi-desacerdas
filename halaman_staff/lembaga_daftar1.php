						...
						<div class="preview">
							<div class="overflow-x-auto">
								<table class="table">
									<thead>
										<tr>
											<th width="30%" class="border border-b-2 whitespace-no-wrap">Nama Lembaga</th>
											<th width="30%" class="border border-b-2 text-center whitespace-no-wrap">Kategori</th>
											<th width="40%" class="border border-b-2 text-center whitespace-no-wrap"></th>
										</tr>
									</thead>
                                    <tbody>
										...
										<tr>
											<td class="border"><?php echo $tampil['nm_lembaga']?></td>
