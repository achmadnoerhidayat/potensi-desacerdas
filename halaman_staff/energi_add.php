...
<?php include "menu_pertambangan03.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Energi Terbarukan</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_energi.php" method="post">
                                ...
                                <div class="preview">
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Jenis Energi" 
												id="txtjns" name="txtjns" autocomplete="off" required>
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Lokasi" 
												id="txtlok" name="txtlok" autocomplete="off" required>
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Potensi (MW)" 
												id="txtpotensi" name="txtpotensi" autocomplete="off" required>
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Kapasitas Terpasang(MW)" 
												id="txtkapasitas" name="txtkapasitas" autocomplete="off" required>
											</div>
										</div>
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Pemanfaatan" 
												id="txtpemanfaatan" name="txtpemanfaatan" autocomplete="off" required>
											</div>
										</div>
