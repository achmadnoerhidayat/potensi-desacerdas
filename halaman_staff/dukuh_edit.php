...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nm_dukuh, deskripsi_wilayah, file_photo, file_name   
...
<?php include "menu_profil07.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Profil Perdukuhan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="dukuh_edit_proses.php" method="post">
								<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Nama Dukuh/Dusun</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" value="<?php echo $nm_dukuh; ?>" >
                                    </div>	
									

										
									<div class="mt-3">
																		<label><b>Deskripsi Dukuh/Dusun</b></label>
										<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="4"><?php echo $deskripsi_wilayah; ?></textarea>                                        
                                    </div>
