                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="save_tpa.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" 
										autocomplete="off" required placeholder="Nama TPA">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlok" name="txtlok" 
										autocomplete="off" required placeholder="Lokasi">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtluas" name="txtluas" 
										autocomplete="off" required placeholder="Luas TPA (Ha)">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtkapasitas" name="txtkapasitas" 
										autocomplete="off" required placeholder="Kapasitas (m3)">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtmasuk" name="txtmasuk" 
										autocomplete="off" required placeholder="Sampah Masuk per hari (m3)">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtangkut" name="txtangkut" 
										autocomplete="off" required placeholder="Sampah diproses per hari (m3)">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtket" name="txtket" 
										autocomplete="off" required placeholder="Keterangan">
                                    </div>
