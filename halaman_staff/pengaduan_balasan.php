...
$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT 
					...
					tbpengaduan.nik, tbpengaduan.nama, tbpengaduan.kd_kategori, tbkategori_pengaduan.nm_kategori, 
					tbpengaduan.isi 
					FROM tbpengaduan, tbkategori_pengaduan 
					WHERE tbpengaduan.kd_kategori=tbkategori_pengaduan.id and tbpengaduan.id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$tgl=$tm_cari['tgl'];
	$nik=$tm_cari['nik'];
	$nm=$tm_cari['nama'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Balas Pengaduan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
                                    <div class="mt-3">
										...
										value="<?php echo $tgl; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2 bg-gray-100 cursor-not-allowed" value="<?php echo $nik; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2 bg-gray-100 cursor-not-allowed" value="<?php echo $nm; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2 bg-gray-100 cursor-not-allowed" value="<?php echo $nm_kategori; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <textarea class="input w-full border mt-2" name="comment" disabled><?php echo $isi; ?></textarea>
                                    </div>									
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
<form action="balas_pengaduan.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
									<div class="mt-3">
                                        <textarea class="input w-full border mt-2" id="txtbalas" name="txtbalas" rows="4" 
										placeholder="Ketik balasan aduan disini" required></textarea>
                                    </div>									
									<button type="submit" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;Kirim&nbsp;&nbsp;&nbsp;   </button>
</form>
                                </div>
                            </div>
                        </div>
