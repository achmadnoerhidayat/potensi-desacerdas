...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT * FROM tbjenis_ikan where kode='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama=$tm_cari['nama'];
?>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="jenis_ikan_edit_proses.php" method="post">
