...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
					kd_tpa, nm_tpa, lokasi_tpa, luas_tpa, kapasitas_tpa, 
					sampah_masuk, sampah_diproses, keterangan 
					FROM tbtpa 
					WHERE id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nm_tps=$tm_cari['nm_tpa'];
	$lok=$tm_cari['lokasi_tpa'];
	$luas=$tm_cari['luas_tpa'];
	$kapasitas=$tm_cari['kapasitas_tpa'];
	$masuk=$tm_cari['sampah_masuk'];
	$angkut=$tm_cari['sampah_diproses'];
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="tpa_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Nama TPA</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" value="<?php echo $nm_tps; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>	
									<div class="mt-3">
										<label><b>Lokasi</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlok" name="txtlok"d value="<?php echo $lok; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Luas TPA (Ha)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtluas" name="txtluas" value="<?php echo $luas; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Kapasitas (m3)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtkapasitas" name="txtkapasitas" value="<?php echo $kapasitas; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Sampah Masuk per hari (m3)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtmasuk" name="txtmasuk" value="<?php echo $masuk; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Sampah diproses per hari (m3)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtangkut" name="txtangkut" value="<?php echo $angkut; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Keterangan</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtket" name="txtket" value="<?php echo $ket; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>
