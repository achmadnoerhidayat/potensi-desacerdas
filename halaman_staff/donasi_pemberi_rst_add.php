...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <!-- BEGIN: Input -->
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_donasi_pemberi.php" method="post">
<input type="hidden" name="txtkd" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama">
                                    </div>							
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtjml" name="txtjml" autocomplete="off" required placeholder="Jumlah Donasi">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txttgl" name="txttgl" autocomplete="off" required placeholder="Tanggal" value="<?php echo $tgl_skr; ?>">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbank" name="txtbank" autocomplete="off" required placeholder="Bank">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnmrek" name="txtnmrek" autocomplete="off" required placeholder="Rekening Atas Nama">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnorek" name="txtnorek" autocomplete="off" required placeholder="Nomor Rekening">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtmode" name="txtmode" required placeholder="Mode Transfer">
                                    </div>
