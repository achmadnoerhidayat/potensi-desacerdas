...
<?php include "menu_penduduk02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Data Kependudukan Berdasarkan RT</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<select class="input pr-12 w-full border col-span-4" id="txtcari" name="txtcari">
																	<option value="">Cari Dukuh/Dusun</option>
																	<?php
								...
								<?php echo $jml_penduduk; ?> jiwa</b>
                                                    	...
                                                    	<td width="10%" class="no-border text-center">
															...
															<a href="report12.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Download&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a target="_blank" href="export_excel12.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export Excel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a href="cetak12.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                </tr>
                                            </tbody>
...
<table class="table"> 
											<thead> 
												<tr> 
													...
													<th class="border border-b-2 whitespace-no-wrap" style="background-color: yellow;"><font size="2"><b>RT</b></font></th>
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													where kode='$kd_kel' and id_dukuh='$txtcari'");
													} else {
												...
												if(isset($_POST['tambah'])){	
													...
													where kode='$kd_kel' and id_dukuh='$txtcari' order by id_dukuh, rt LIMIT $mulai, $halaman")or die(mysql_error);
												} else {
													$query = mysqli_query($koneksi,"select *, DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal from tbpenduduk 
													where kode='$kd_kel' order by id_dukuh, rt LIMIT $mulai, $halaman")or die(mysql_error);
												}
												$no =$mulai+1;
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border text-center" bgcolor="yellow"><font size="2"><?php echo $data['rt']; ?></font></td>		
														...
														<td class="border">
															<form action="penduduk_detail01.php" method="post">			
																...
																<input type="hidden" name="txtform" value="12"/>
														...
														<td class="border">
																<a href="penduduk_del.php?txtid=<?php echo $data['id']?>&txtform=12" 
