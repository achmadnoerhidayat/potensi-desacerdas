            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <a href="tps_add.php?kdkel=<?php echo $kd_kel; ?>"><button class="button text-white bg-theme-1 shadow-md mr-2">
							Tambah Data
						</button></a><br>&nbsp;
													...
													<tr>								
														...
														<td class="border text-center">
															<div class="flex sm:justify-center items-center">
																<a class="flex items-center mr-3" href="tps_edit.php?kd=<?php echo $data['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
																<a class="flex items-center text-theme-6" href="tps_del.php?kd=<?php echo $data['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
														</td>
													</tr>
												</tbody>
												<?php               
