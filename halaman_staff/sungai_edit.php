...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT nama_sungai, panjang, lebar, kedalaman, debit, kondisi, potensi, 
					tgl_input, jam_input, user_id, kode, file_photo, file_name   
					FROM tbsungai where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama_sungai=$tm_cari['nama_sungai'];
	$p=$tm_cari['panjang'];
	$l=$tm_cari['lebar'];
	$kedalaman=$tm_cari['kedalaman'];
	$debit=$tm_cari['debit'];
	$kondisi=$tm_cari['kondisi'];
	$pemanfaatan=$tm_cari['potensi'];
	$file_photo=$tm_cari['file_photo'];
	$file_name=$tm_cari['file_name'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Sungai</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Sungai</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="sungai_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" value="<?php echo $nama_sungai; ?>">
                                    </div>	
									
										<div class="mt-3">
											<div class="sm:grid grid-cols-4 gap-2">
												<div class="relative mt-2">
													<label><b>Panjang (km)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtp" name="txtp" value="<?php echo $p; ?>" >
												</div>
												<div class="relative mt-2">
													<label><b>Lebar (meter)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtl" name="txtl" value="<?php echo $l; ?>" >
												</div>
												<div class="relative mt-2">
													<label><b>Kedalaman (meter)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtdalam" name="txtdalam" value="<?php echo $kedalaman; ?>" >
												</div>
												<div class="relative mt-2">
													<label><b>Debit Air (m3/detik)</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
									...
									<div class="mt-3">
																		<label><b>Deskripsi/Uraian</b></label>
