                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_jenis_tanaman.php" method="post">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Jenis Tanaman</b></label>
                                        						<input type="text" class="input w-full border mt-2" 
											id="txtjenis" name="txtjenis" autocomplete="off" required placeholder="Jenis Tanaman">
                                    					</div>	
...
<?php
													$sql="select distinct(kelompok) as kel FROM tbjenis_tanaman";
