...
<?php include "menu_profil07.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Profil Perdukuhan</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Profil Perdukuhan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="save_profil_dukuh.php" method="post">
<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Dukuh/Dusun">
                                    </div>	
										...
										<div class="mt-3">
											<div class="sm:grid grid-cols-3 gap-2">
												<div class="relative mt-2">
													...
													id="txtluas" name="txtluas" autocomplete="off" required placeholder="Luas Danau (Ha)">
												</div>
												<div class="relative mt-2">
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtdalam" name="txtdalam" autocomplete="off" required placeholder="Kedalaman Danau (m)">
												</div>
												<div class="relative mt-2">
					...
					<div class="mt-3">
	                                    ...
	                                    <div>
	                                        <label><b>Upload Foto Danau</b></label>
						<input type="file" name="gambar" class="input w-full border mt-2" required />
