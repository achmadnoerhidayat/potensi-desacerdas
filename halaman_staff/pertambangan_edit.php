...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT kd_tambang, luas, produksi, lahan, sistem FROM tbpertambangan where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$kd_tambang=$tm_cari['kd_tambang'];
	$luas=$tm_cari['luas'];
	$produksi=$tm_cari['produksi'];
	$lahan=$tm_cari['lahan'];
	$sistem=$tm_cari['sistem'];
?>
...
<?php include "menu_pertambangan02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Potensi Bahan Galian</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="pertambangan_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">

					<div class="mt-3">
										<label><b>Jenis Bahan Galian</b></label>
													<select class="input pr-12 w-full border col-span-4" name="cbojns" id="cbojns" required>
														<option value=""></option>
											<?php
												$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_tambang");
												while ($row1 = mysqli_fetch_array($q)){
													$k_id           = $row1['kode'];
													$k_opis         = $row1['nama'];
											?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_tambang){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
											<?php
												}
											?>
													</select>
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Luas Sebaran (m2)</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" id="txtluas" name="txtluas" value="<?php echo $luas; ?>">
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Produksi (ton)</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" id="txtton" name="txtton" value="<?php echo $produksi; ?>">
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Konversi/Jenis Lahan</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" id="txtlahan" name="txtlahan" value="<?php echo $lahan; ?>">
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Sistem Penambangan</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" id="txtsistem" name="txtsistem" value="<?php echo $sistem; ?>">
											</div>
										</div>
