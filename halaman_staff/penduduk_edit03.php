	...
	if(isset($_POST['submit1'])) {
		...
		if($menetap=='Lahir Di') {
			...
			mysqli_query($koneksi,"UPDATE tbpenduduk 
						SET menetap='$menetap', menetap_ket1='$ket_menetap1', menetap_ket2='$ket_menetap2', menetap_ket3='$ket_menetap3', 
						menetap_ket4='$ket_menetap4', 
						tgl_register='$tgl_lhr' WHERE id='$id'");
		...
		if($menetap=='Pindah Ke') {
			...
			mysqli_query($koneksi,"UPDATE tbpenduduk 
						SET menetap='$menetap', menetap_ket1='$ket_menetap1', menetap_ket2='$ket_menetap2', menetap_ket3='$ket_menetap3', 
						menetap_ket4='$ket_menetap4', 
						tgl_register='$txttglpindah', tgl_pindah='$txttglpindah' WHERE id='$id'");
		...
		if($menetap=='Meninggal') {
			...
			mysqli_query($koneksi,"UPDATE tbpenduduk 
						SET menetap='$menetap', menetap_ket1='$ket_menetap1', menetap_ket2='$ket_menetap2', menetap_ket3='$ket_menetap3', 
						menetap_ket4='$ket_menetap4', 
						Menetap_tgl='$txttglmeninggal', tgl_register='$txttglmeninggal', jam_kematian='$txtjam' WHERE id='$id'");
			//$sql_insert="INSERT INTO tbrekap_penduduk (kode, tanggal, tgl, bln, tahun, tipe) 
		...
		if($menetap=='Hilang') {
			...
			mysqli_query($koneksi,"UPDATE tbpenduduk 
						SET menetap='$menetap', menetap_ket1='$ket_menetap1', menetap_ket2='$ket_menetap2', menetap_ket3='$ket_menetap3', 
						menetap_ket4='$ket_menetap4', 
						tgl_hilang='$txttglhilang', tgl_register='$txttglhilang' WHERE id='$id'");
			//$sql_insert="INSERT INTO tbrekap_penduduk (kode, tanggal, tgl, bln, tahun, tipe) 
...
<form class="form-horizontal" action="penduduk_edit04.php" method="post">
										...
										<div>
											...
											<div class="flex items-center text-gray-700 mt-2">
												<div class="sm:grid grid-cols-3 gap-2">
													<div class="relative mt-2">
														<input type="radio" class="input border mr-2" name="jenis_kelamin" value="Belum E-KTP" <?php if ($ktp=="Belum E-KTP") echo "checked";?>> Belum E-KTP
													</div>
													<div class="relative mt-2">
											...
											<div class="flex items-center text-gray-700 mt-2">
												<div class="sm:grid grid-cols-2 gap-2">
													<div class="relative mt-2">
														<input type="radio" class="input border mr-2" name="jenis_kelamin" value="Sudah E-KTP" <?php if ($ktp=="Sudah E-KTP") echo "checked";?>> Sudah E-KTP
													</div>
													<div class="relative mt-2">
