                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="save_tps.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" 
										autocomplete="off" required placeholder="Nama TPS">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
									...
									<div class="mt-3">
										...
										autocomplete="off" required placeholder="Luas TPS (Ha)">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
									...
									<div class="mt-3">
										...
										autocomplete="off" required placeholder="Sampah diangkut per hari (m3)">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
