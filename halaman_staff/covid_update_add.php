                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-4">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="covid_update_input_save.php" method="post">
<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" autocomplete="off" required placeholder="Suspect">
                                    </div>							
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" autocomplete="off" required placeholder="Probable">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt3" name="txt3" autocomplete="off" required placeholder="Positif">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt4" name="txt4" autocomplete="off" required placeholder="Perawatan">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt5" name="txt5" autocomplete="off" required placeholder="Meninggal">
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt6" name="txt6" autocomplete="off" required placeholder="Sembuh">
                                    </div>
