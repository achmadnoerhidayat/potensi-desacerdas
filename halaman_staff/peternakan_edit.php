...
$id=$_GET['kd'];
	...
	$cari_kd=mysqli_query($koneksi,"SELECT kd_ternak, jumlah FROM tbpeternakan where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$kd_ternak=$tm_cari['kd_ternak'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Potensi Peternakan</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="peternakan_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<option value=""></option>
											<?php
												$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_ternak");
												while ($row1 = mysqli_fetch_array($q)){
													$k_id           = $row1['kode'];
													$k_opis         = $row1['nama'];
											?>
											<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_ternak){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
											<?php
												}
											?>
										</select>
									...
									<div class="mt-3">
										<label><b>Jumlah Populasi (ekor)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtjml" name="txtjml" value="<?php echo $jumlah; ?>" 
