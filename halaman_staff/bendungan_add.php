...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Bendungan/Waduk</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_bendungan.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Bendungan">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnms" name="txtnms" autocomplete="off" required placeholder="Nama Sungai">
                                    </div>
										...
										<div class="mt-3">
											<div class="sm:grid grid-cols-3 gap-2">
												<div class="relative mt-2">
													...
													id="txtp" name="txtp" autocomplete="off" required placeholder="Panjang (m)">
												</div>
												<div class="relative mt-2">
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtluas" name="txtluas" autocomplete="off" required placeholder="Luas Area (ha)">
												</div>
												<div class="relative mt-2">
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txttahun" name="txttahun" autocomplete="off" required placeholder="Tahun Pembuatan">
												</div>
											</div>
										</div>
										...
										<div class="mt-3">
													...
													<select class="input pr-12 w-full border col-span-4" id="cbokondisi" name="cbokondisi" required>
														<option value="">Kondisi Bendungan</option>
															<?php
																$sql="select kode, kondisi FROM tbkondisi_sungai";
			       												$sql_row=mysqli_query($koneksi,$sql);
																	while($sql_res=mysqli_fetch_assoc($sql_row))	
																		{
															?>
														<option value="<?php echo $sql_res["kondisi"]; ?>"><?php echo $sql_res["kondisi"]; ?></option>
			       											<?php
			       												}
			       											?>
													</select>
									...
									<div class="mt-3">
										<textarea class="input w-full border mt-2" id="txtpotensi" name="txtpotensi" rows="4" 
										placeholder="Deskripsi/Uraian/Pemanfaatan" required></textarea>                                        
                                    </div>

									<div class="mt-3">
	                                    <div>
	                                        <label><b>Upload Foto Bendungan</b></label>
									...
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnmsal" name="txtnmsal" autocomplete="off" required placeholder="Nama Saluran">
                                    </div>
										...
										<div class="mt-3">
											<div class="sm:grid grid-cols-2 gap-2">
												<div class="relative mt-2">
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txt1" name="txt1" autocomplete="off" required placeholder="Lebar Saluran (m)">
												</div>
												<div class="relative mt-2">
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtdebit" name="txtdebit" autocomplete="off" required placeholder="Debit Saluran (m3/det)">
												</div>
