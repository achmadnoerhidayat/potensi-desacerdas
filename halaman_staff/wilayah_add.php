...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Wilayah</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_wilayah.php" method="post">
						                                ...
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																...
																<div class="mt-3">
																	...
																	id="txtrt" name="txtrt" autocomplete="off" required placeholder="Jumlah RT">
						                                        </div>
																<div class="mt-3">
                                        							<input type="text" class="input w-full border mt-2" 
																...
																<div class="mt-3">
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtpersen" name="txtpersen" autocomplete="off" required placeholder="Persentase %">
						                                        </div>	
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		...
																		<div class="relative mt-2">
																			<button class="button text-white bg-theme-1 shadow-md mr-2">
																				<a href="dukuh_add.php">Tambah Data Dukuh/Dusun</a>
																			</button>																			
																		</div>
																	</div>
						                                        </div>
