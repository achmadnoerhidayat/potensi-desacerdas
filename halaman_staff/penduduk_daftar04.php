...
<?php include "menu_penduduk02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Data Kependudukan Berdasarkan Agama</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box p-5">
                                        ...
                                        <table class="table">
											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													...
													<select class="input pr-12 w-full border col-span-4" id="txtcari" name="txtcari">
																			<option value="">Cari Agama</option>
																				<?php
								...
								<b><?php echo $jml_laki; ?> jiwa<br>
								<?php echo $jml_perempuan; ?> jiwa
								<hr>
								<?php echo $jml_penduduk; ?> jiwa</b>
							</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a href="report04.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Download&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a target="_blank" href="export_excel04.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export Excel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a href="cetak04.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                </tr>
                                            </tbody>
...
<table class="table"> 
											<thead> 
												<tr> 
													...
													<th class="border border-b-2 whitespace-no-wrap" style="background-color: yellow;"><font size="2"><b>Agama</b></font></th>
													...
													<th colspan="3" class="border border-b-2 whitespace-no-wrap"><font size="2"></font></th>
												</tr> 
											</thead>  
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													$result = mysqli_query($koneksi,"SELECT * FROM tbpenduduk where kode='$kd_kel' and id_agama='$txtcari'");
													} else {
												...
												if(isset($_POST['tambah'])){	
													...
													where kode='$kd_kel' and id_agama='$txtcari' order by id_agama LIMIT $mulai, $halaman")or die(mysql_error);
												} else {
													$query = mysqli_query($koneksi,"select *, DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal from tbpenduduk 
													where kode='$kd_kel' order by id_agama LIMIT $mulai, $halaman")or die(mysql_error);
												}
												$no =$mulai+1;
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border text-center" bgcolor="yellow"><font size="2"><?php echo $agama; ?></font></td>
														...
														<td class="border">
																<a href="penduduk_del.php?txtid=<?php echo $data['id']?>&txtform=4" 
