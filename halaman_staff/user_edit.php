...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nip, nama, password, level_akses, email, user_name FROM tbuser WHERE id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama=$tm_cari['nama'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<a href="" class="">Managemen User</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit User</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="user_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">									
										...
										id="txtnip" name="txtnip" autocomplete="off" value="<?php echo $nip ?>">
                                    </div>									
									...
									<div class="mt-3">									
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtuser" name="txtuser" autocomplete="off" required value="<?php echo $user_name ?>">
									</div>

									<div class="mt-3">									
										<label><b>Email</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtemail" name="txtemail" autocomplete="off" required value="<?php echo $email ?>">
									</div>

									<div class="mt-3">									
										<label><b>Role/Hak Akses</b></label>
										<select class="input w-full border mt-2" name="cbolevel" id="cbolevel" required>
<?php
									...
									<div class="mt-3">									
										...
										id="txtpwd" name="txtpwd" autocomplete="off" required value="<?php echo $password ?>">
									</div>

									<div class="mt-3">									
										<label><b>Konfirmasi Password</b></label>
										<input type="password" class="input w-full border mt-2" 
										id="txtpwdk" name="txtpwdk" autocomplete="off" required value="<?php echo $password ?>">
									</div>
