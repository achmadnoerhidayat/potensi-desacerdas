...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nama_danau, luas, kedalaman, kondisi, pemanfaatan, 
					tgl_input, jam_input, user_id, 
					kode, file_photo 
					FROM tbdanau where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama_danau=$tm_cari['nama_danau'];
	$luas=$tm_cari['luas'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Danau</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Danau</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
