...
<?php include "menu_bendungan.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Bendungan/Waduk</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="border border-gray-200 rounded-md p-5">
												<center>
                                                <img class="rounded-md" alt="Photo Mata Air" src="<?php echo $file_photo; ?>" width="550px">
												</center>
                                        </div>
                                    </div>										
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="mt-3">
                                            <label>Panjang Bendungan</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $panjang; ?> meter" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Luas Area</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $luas; ?> Ha" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Tahun Pembuatan</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $tahun; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Nama Sungai</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $nm_sungai; ?>" disabled>
                                        </div>
									</div>
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-12">
                                        <div class="mt-3">
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="Nama Saluran : <?php echo $nm_saluran; ?>" disabled>
											
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="Lebar Saluran : <?php echo $lebar; ?> meter" disabled>

                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="Debit Saluran : <?php echo $debit; ?> m3/det" disabled>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
                        ...
                        <div class="intro-y box lg:mt-5">
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-12">
                                        <div>
											<textarea class="input w-full border bg-gray-100 cursor-not-allowed mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" disabled><?php echo $pemanfaatan; ?></textarea>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
