...
session_start();
	...
	$nm_kel=$tm_cari['nama'];
		...
		$cari_kd=mysqli_query($koneksi,"SELECT 
			...
			WHERE kode='$kd_kel'");
		$tm_cari=mysqli_fetch_array($cari_kd);
		$morfologi=$tm_cari['morfologi'];
		$fisika1=$tm_cari['fisika_1'];
		$fisika2=$tm_cari['fisika_2'];
		$fisika3=$tm_cari['fisika_3'];
		$fisika4=$tm_cari['fisika_4'];
		$kimia1=$tm_cari['kimia_1'];
		$kimia2=$tm_cari['kimia_2'];
		$kimia3=$tm_cari['kimia_3'];
		$analisis=$tm_cari['analisa'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Tanah</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" action="save_tanah.php" method="post">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
					<div class="mt-3">
						<label><b>Morfologi Tanah</b></label>
                                        	<textarea class="input w-full border mt-2" id="txtmorfologi" name="txtmorfologi" rows="3" placeholder="Morfologi Tanah" required><?php echo $morfologi; ?></textarea>
                                    	</div>	
					<br>
					<label><b>Sifat Fisika Tanah</b></label>
					<div class="mt-3">
						<label>Struktur Tanah</label>
                                        	<textarea class="input w-full border mt-2" id="txtfisika1" name="txtfisika1" rows="3" placeholder="Struktur Tanah" required><?php echo $fisika1; ?></textarea>
                                    	</div>	
					<div class="mt-3">
						<label>Konsistensi Tanah</label>
                                        	<textarea class="input w-full border mt-2" id="txtfisika2" name="txtfisika2" rows="3" placeholder="Konsistensi Tanah" required><?php echo $fisika2; ?></textarea>
                                    	</div>
					<div class="mt-3">
						<label>Tekstur Tanah</label>
                                        	<textarea class="input w-full border mt-2" id="txtfisika3" name="txtfisika3" rows="3" placeholder="Tekstur Tanah" required><?php echo $fisika3; ?></textarea>
                                    	</div>
					<div class="mt-3">
						<label>Bobot Isi Tanah</label>
                                        	<textarea class="input w-full border mt-2" id="txtfisika4" name="txtfisika4" rows="3" placeholder="Bobot Isi Tanah" required><?php echo $fisika4; ?></textarea>
                                    	</div>
					<br>
					<label><b>Sifat Kimia Tanah</b></label>
					<div class="mt-3">
						<label>PH Tanah</label>
                                        	<textarea class="input w-full border mt-2" id="txtkimia1" name="txtkimia1" rows="3" placeholder="PH Tanah" required><?php echo $kimia1; ?></textarea>
                                    	</div>
					<div class="mt-3">
						<label>Potensial Redoks</label>
                                        	<textarea class="input w-full border mt-2" id="txtkimia2" name="txtkimia2" rows="3" placeholder="Potensial Redoks" required><?php echo $kimia2; ?></textarea>
                                    	</div>	
					<div class="mt-3">
						<label>C-Organik</label>
                                        	<textarea class="input w-full border mt-2" id="txtkimia3" name="txtkimia3" rows="3" placeholder="C-Organik" required><?php echo $kimia3; ?></textarea>
                                    	</div>
					<br>
					<div class="mt-3">
						<label><b>Analisis/Kesimpulan</b></label>
                                        	<textarea class="input w-full border mt-2" id="txtanalisis" name="txtanalisis" rows="3" placeholder="Analisis/Kesimpulan" required><?php echo $analisis; ?></textarea>
                                    	</div>
