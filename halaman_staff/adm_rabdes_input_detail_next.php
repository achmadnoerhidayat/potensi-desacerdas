...
<?php 
									$sql = mysqli_query($koneksi,"SELECT kode, nama FROM tbrek where left(kode,1)='2'");
									while ($tampil = mysqli_fetch_array($sql)) {
										$kode=$tampil['kode'];
										$digit=strlen($kode);
								?>
...
<?php 
									$sql = mysqli_query($koneksi,"SELECT kode, nama FROM tbrek where left(kode,1)='3' and left(kode,2)='31'");
									while ($tampil = mysqli_fetch_array($sql)) {
										$kode=$tampil['kode'];
										$digit=strlen($kode);
								?>
...
<?php 
									$sql = mysqli_query($koneksi,"SELECT kode, nama FROM tbrek where left(kode,1)='3' and left(kode,2)='32'");
									while ($tampil = mysqli_fetch_array($sql)) {
										$kode=$tampil['kode'];
										$digit=strlen($kode);
								?>
