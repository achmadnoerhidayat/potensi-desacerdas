                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="save_biofarmeka.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<option value="">Jenis Tanaman Biofarmeka</option>
										<?php
											$sql="select kode, nama FROM tbjenis_tanaman where kelompok='Tanaman Obat'";
									...
									<div class="mt-3">
										...
										autocomplete="off" required placeholder="Luas Panen (m2)">
                                    </div>	
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtproduksi" name="txtproduksi" 
										autocomplete="off" required placeholder="Jumlah Produksi (kg)">
                                    </div>
