...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									kode, tahun, nama, umur, id_jk, pendidikan, bidang, alamat, keterangan, 
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" action="adm_kader_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										value="<?php echo $tahun; ?>" autocomplete="off" placeholder="Tahun Anggaran" >
                                    </div>							
								</div>
                            </div>
                        </div>
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Isian Table Buku Kader Pemberdayaan Masyarakat</b></label>
                                    </div>			
									<div class="mt-3">
										<input type="text" class="input w-full border mt-2" 
										id="txttgl" name="txttgl" placeholder="Tanggal" value="<?php echo $tgl_skr; ?>">
										
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" placeholder="Nama Lengkap" value="<?php echo $nama; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtumur" name="txtumur" placeholder="Umur" value="<?php echo $umur; ?>" >
                                    
                                        <select class="input w-full border mt-2" name="cbojk" id="cbojk" required>
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpendidikan" name="txtpendidikan" placeholder="Pendidikan/Kursus" value="<?php echo $pendidikan; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbidang" name="txtbidang" placeholder="Bidang" value="<?php echo $bidang; ?>">
                                   
                                        <textarea class="input w-full border mt-2" id="txtalamat" name="txtalamat" rows="3" 
										placeholder="Alamat" required><?php echo $alamat; ?></textarea>
                                    
                                        <textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="3" 
										placeholder="Keterangan" required><?php echo $keterangan; ?></textarea>
                                    </div>	
