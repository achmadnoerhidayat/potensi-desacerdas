...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Buku Bank</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="adm_bank_input_save.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										value="" required autocomplete="off" placeholder="Tahun Anggaran" >
										<select class="input w-full border mt-2" name="cbobln" id="cbobln" required>
										<option value="">Bulan</option>
										<?php
											$sql="select bulan FROM tbbulan order by id";
			       							$sql_row=mysqli_query($koneksi,$sql);
			       							while($sql_res=mysqli_fetch_assoc($sql_row))	
												{
										?>
										<option value="<?php echo $sql_res["bulan"]; ?>"><?php echo $sql_res["bulan"]; ?></option>
			       						<?php
			       							}
			       						?>
										</select>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txttgl" name="txttgl" placeholder="Tanggal Transaksi" value="<?php echo $tgl_skr; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txturaian" name="txturaian" placeholder="Uraian Transaksi" autocomplete="off">
                                    </div>									
									<br>								
									<div class="mt-3">
										<label><b>Surat Keluar</b></label>
									...
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" placeholder="Setoran" autocomplete="off">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" placeholder="Bunga Bank" autocomplete="off">
                                    </div>	
									<br>
									<div class="mt-3">
										<label><b>Pengeluaran</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt3" name="txt3" placeholder="Penarikan" autocomplete="off">
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt4" name="txt4" placeholder="Pajak" autocomplete="off">
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt5" name="txt5" placeholder="Administrasi Bank" autocomplete="off">
                                    </div>									
