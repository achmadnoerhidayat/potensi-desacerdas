...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" action="adm_inventaris_input_save.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" placeholder="Hasil Pembangunan" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtvol" name="txtvol" placeholder="Volume" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbiaya" name="txtbiaya" placeholder="Biaya" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlok" name="txtlok" placeholder="Lokasi" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtket" name="txtket" placeholder="Keterangan" value="">
                                    </div>	
