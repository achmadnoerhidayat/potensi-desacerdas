...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nama, dasar, tujuan, kegiatan, hasil FROM tbpengelolaan_sampah where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama=$tm_cari['nama'];
	$dasar=$tm_cari['dasar'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Pengelolaan Sampah</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="pengelolaan_sampah_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" value="<?php echo $nama; ?>" required placeholder="">
                                    </div>	
									<div class="mt-3">
										<label><b>Dasar Aturan</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtdasar" name="txtdasar" value="<?php echo $dasar; ?>" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><b>Tujuan</b></label>
										<textarea class="input w-full border mt-2" id="txttujuan" name="txttujuan" rows="3" 
										placeholder="" required><?php echo $tujuan; ?></textarea>
                                    </div>
									<div class="mt-3">
										<label><b>Kegiatan Yang dilakukan</b></label>
										<textarea class="input w-full border mt-2" id="txtkeg" name="txtkeg" rows="3" 
										placeholder="" required><?php echo $kegiatan; ?></textarea>
                                    </div>
									<div class="mt-3">
										<label><b>Hasil/Manfaat</b></label>
										<textarea class="input w-full border mt-2" id="txthasil" name="txthasil" rows="3" 
										placeholder="" required><?php echo $hasil; ?></textarea>
                                    </div>
