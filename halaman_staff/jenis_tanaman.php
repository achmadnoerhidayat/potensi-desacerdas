											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													<td width="80%" class="no-border">
														...
														placeholder="Cari Nama Jenis Tanaman" id="txtcari" name="txtcari">               
													</td>
						...
						<th class="border text-center whitespace-no-wrap">AKSI</th>
							...
							<td class="border text-center">
								<div class="flex sm:justify-center items-center">
									<a class="flex items-center mr-3" href="jenis_tanaman_edit.php?kd=<?php echo $data['kode']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
									<a class="flex items-center text-theme-6" href="jenis_tanaman_del.php?kd=<?php echo $data['kode']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
								</div>
							</td>
													</tr>
												</tbody>
