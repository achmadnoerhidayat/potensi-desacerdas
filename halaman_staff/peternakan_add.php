                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="save_peternakan.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										<option value="">Jenis Ternak</option>
										<?php
											$sql="select kode, nama FROM tbjenis_ternak";
									...
									<div class="mt-3">
										...
										id="txtjml" name="txtjml" 
										autocomplete="off" required placeholder="Jumlah Populasi (ekor)">
                                    </div>	
