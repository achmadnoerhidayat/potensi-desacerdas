...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
					kd_tps, nm_tps, lokasi_tps, luas_tps, kapasitas_tps, 
					sampah_masuk, sampah_diangkat, keterangan 
					FROM tbtps 
					WHERE id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nm_tps=$tm_cari['nm_tps'];
	$lok=$tm_cari['lokasi_tps'];
	$luas=$tm_cari['luas_tps'];
	$kapasitas=$tm_cari['kapasitas_tps'];
	$masuk=$tm_cari['sampah_masuk'];
	$angkut=$tm_cari['sampah_diangkat'];
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="tps_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Sampah diangkut per hari (m3)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtangkut" name="txtangkut" value="<?php echo $angkut; ?>"  
										autocomplete="off" required placeholder="">
                                    </div>
									<div class="mt-3">
										<label><bKeterangan</b></label>
                                        <input type="text" class="input w-full border mt-2" 
