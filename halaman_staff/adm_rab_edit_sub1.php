...
session_start();
	...
	$id_sub = $_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT * from tbrab_sub 
									where id='$id_sub'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$id=$tm_cari['kode_rab'];
	$txtnoangg=$tm_cari['no_anggaran'];
	$txturaian1=$tm_cari['uraian_sub'];
	...
	if(isset($_POST['btnsub'])) {
		$txtid = $_POST['txtid'];
		$txtidsub = $_POST['txtidsub'];
		$txtnoangg = $_POST['txtnoangg'];
		$txturaian1 = $_POST['txturaian1'];
		
		mysqli_query($koneksi,"UPDATE tbrab_sub SET no_anggaran='$txtnoangg', uraian_sub='$txturaian1' WHERE id='$txtidsub'");
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
			...
			<input type="hidden" name="txtidsub" value="<?php echo $id_sub; ?>"/>
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">											
                                        <input class="input pr-12 w-full border col-span-4" placeholder="Nomor Anggaran" 
										id="txtnoangg" name="txtnoangg" value="<?php echo $txtnoangg; ?>">
									</div>
									<div class="mt-3">
										<input class="input pr-12 w-full border col-span-4" placeholder="Uraian" 
										id="txturaian1" name="txturaian1" value="<?php echo $txturaian1; ?>">                                    
                                    </div>	
									<div class="relative mt-2 text-right">
											<button type="submit" name="btnsub" class="button text-white bg-theme-1 shadow-md mr-2">Simpan</button>
									</div>
								</div>
                            </div>
                        </div>
