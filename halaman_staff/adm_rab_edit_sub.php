...
session_start();
	...
	if(isset($_POST['btnsub'])) {
		$txtid = $_POST['txtid'];
		$txtnoangg = $_POST['txtnoangg'];
		$txturaian1 = $_POST['txturaian1'];
		
		mysqli_query($koneksi,"INSERT INTO tbrab_sub (kode_rab, no_anggaran, uraian_sub) VALUES ('$txtid','$txtnoangg','$txturaian1')");
	}
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">											
                                        <input class="input pr-12 w-full border col-span-4" placeholder="Nomor Anggaran" id="txtnoangg" name="txtnoangg">
									</div>
									<div class="mt-3">
										<input class="input pr-12 w-full border col-span-4" placeholder="Uraian" id="txturaian1" name="txturaian1">                                    
                                    </div>	
									<div class="relative mt-2 text-right">
											<button type="submit" name="btnsub" class="button text-white bg-theme-1 shadow-md mr-2">+ Tambahkan</button>
									</div>
								</div>
								<br>
									<table class="table table--sm" width="100%"> 
										<thead> 
											<tr> 														
												<th width="10%" class="border text-center whitespace-no-wrap">Nomor Anggaran</th>
												<th width="80%" class="border whitespace-no-wrap">Uraian</th>
										...
										<?php 
											//kode_rab
											$query = mysqli_query($koneksi,"SELECT * FROM tbrab_sub where kode_rab='$id'")or die(mysql_error);	
											while ($data = mysqli_fetch_assoc($query)) {		
										?>

										<tbody>
											<tr>
												<td class="border text-center"><?php echo $data['no_anggaran']; ?></td>    
												<td class="border"><?php echo $data['uraian_sub']; ?></td>    
												<td class="border text-center">
													<div class="flex sm:justify-center items-center">
														<a class="flex items-center mr-3" href="adm_rab_edit_sub1.php?kd=<?php echo $data['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i></a>
														<a class="flex items-center text-theme-6" href="adm_rab_del_sub.php?kd=<?php echo $data['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i></a>
													</div>															
												</td>								  
											</tr>
										</tbody>
