...
<form class="form-horizontal" action="adm_kader_input_save.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" placeholder="Nama Lengkap" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtumur" name="txtumur" placeholder="Umur" value="">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpendidikan" name="txtpendidikan" placeholder="Pendidikan/Kursus" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbidang" name="txtbidang" placeholder="Bidang" value="">
