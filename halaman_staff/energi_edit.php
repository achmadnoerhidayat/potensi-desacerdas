...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
					jenis_energi, lokasi, potensi, kapasitas, pengelola, pemanfaatan FROM tbenergi 
					WHERE id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$txtjns=$tm_cari['jenis_energi'];
	$lok=$tm_cari['lokasi'];
	$potensi=$tm_cari['potensi'];
	$kapasitas=$tm_cari['kapasitas'];
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="energi_edit_proses.php" method="post">
                                ...
                                <div class="preview">
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Jenis Energi</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" id="txtjns" name="txtjns" value="<?php echo $txtjns; ?>">
											</div>
										</div>
										...
										<div class="mt-3">
											<div class="relative mt-2">
												...
												id="txtlok" name="txtlok" value="<?php echo $lok; ?>">
											</div>
										</div>

										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Potensi (MW)</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="" 
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Kapasitas Terpasang(MW)</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="" 
