...
<form class="form-horizontal" action="lembaga_edit02.php" method="post">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                ...
                                <div class="preview">
									...
									<div class="mt-3">
										<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="6"><?php echo $wewenang; ?></textarea>                                        
                                    </div>
