...
session_start();
	...
	if(isset($_POST['submit1'])) {
		...
		$data = mysqli_query($koneksi,"SELECT * FROM tbrapbes WHERE tahun='$txttahun' and kode='$kd_kel'"); 
		...
		if($cek > 0){
			...
			mysqli_query($koneksi,"INSERT INTO tbrapbes (kode, tahun) VALUES ('$kd_kel','$txttahun')");
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Rancangan APBDes</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
