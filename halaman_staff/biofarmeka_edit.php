...
$id=$_GET['kd'];
	...
	$cari_kd=mysqli_query($koneksi,"SELECT kd_tumbuhan, luas_panen, produksi FROM tbpertanian where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Tanaman Biofarmeka</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="biofarmeka_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Jenis Tanaman Biofarmeka</b></label>
										<select class="input pr-12 w-full border col-span-4" id="cbojenis" name="cbojenis" required>
										<option value=""></option>
										<?php
												$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_tanaman where kelompok='Tanaman Obat'");
									...
									<div class="mt-3">
										<label><b>Jumlah Produksi (kg)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
