...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Buku Bank</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										value="<?php echo $tahun; ?>" disabled>

										<label><b>Bulan</b></label>
                                        <input type="text" class="input w-full border mt-2" id="txtbln" name="txtbln" 
										value="<?php echo $bulan; ?>" disabled>
                                    </div>									
								</div>
                            </div>
                        </div>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										id="txttgl" name="txttgl" disabled value="<?php echo $tgl; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txturaian" name="txturaian" disabled value="<?php echo $uraian; ?>">
                                    </div>									
									<br>								
									<div class="mt-3">
										<label><b>Surat Keluar</b>&nbsp;
													<a href="javascript:void(0);" onClick="newPopup('peta_detail.php?img=<?php echo $file_photo1; ?>');"><?php echo $file_photo1; ?></a>
													</label>
                                    </div>	
									<br>
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" disabled value="<?php echo number_format($txt1,0) ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" disabled value="<?php echo number_format($txt2,0) ?>">
                                    </div>	
									<br>
									<div class="mt-3">
										<label><b>Pengeluaran</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt3" name="txt3" disabled value="<?php echo number_format($txt3,0) ?>">
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt4" name="txt4" disabled value="<?php echo number_format($txt4,0) ?>">
                                        <input type="text" class="input w-full border mt-2" 
										 id="txt5" name="txt5" disabled value="<?php echo number_format($txt5,0) ?>">
                                    </div>									
