...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Pengaduan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form class="form-horizontal" action="save_pengaduan.php" method="post">
<input type="hidden" name="txtkdkel" value="<?php echo $kd_kel; ?>"/>
                        ...
                        <div class="intro-y box">
                            <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                                ...
                                <div class="p-5">
                                    <div class="mt-3">
                                        <input type="text" class="input pr-12 w-full border col-span-4" placeholder="Tanggal Input"
...
<input type="text" class="input pr-12 w-full border col-span-4" placeholder="NIK"
									...
									<div class="mt-3">
<select class="input pr-12 w-full border col-span-4" name="cbokategori" id="cbokategori" required>
													<option value="">Kategori Pengaduan</option>
														<?php
															$sql="select nm_kategori, id FROM tbkategori_pengaduan";
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        <textarea class="input w-full border mt-2" id="txtisi" name="txtisi" rows="4"
