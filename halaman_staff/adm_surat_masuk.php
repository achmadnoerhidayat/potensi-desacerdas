...
<?php include "menu_adm02b.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Buku Agenda Surat Masuk BPD</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-5 intro-y">
									<div class="intro-y block sm:flex items-center h-10">
										<div class="flex items-center sm:ml-auto mt-12 sm:mt-0">
											<button class="button box flex items-center text-gray-700"> <i data-feather="printer" class="hidden sm:block w-4 h-4 mr-2"></i> <a target="_blank" href="cetak_surat_masuk.php"> Print </a></button>
											<button class="ml-3 button box flex items-center text-gray-700"> <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> <a target="_blank" href="export_excel_surat_masuk.php"> Export to Excel </a></button>
											<button class="ml-3 button box flex items-center text-gray-700"> <i data-feather="file-text" class="hidden sm:block w-4 h-4 mr-2"></i> <a target="_blank" href="export_pdf_surat_masuk.php"> Export to PDF </a></button>
										</div>
									</div>
                                </div>
                            </div>
										...
										<table class="table table--sm" width="100%">
											<thead>
												<tr>
													...
													<td class="border text-center whitespace-no-wrap" colspan="4"> <b>Surat Masuk</b></td>
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													//}
													if($txtcari<>'') {
														$result = mysqli_query($koneksi,"SELECT * FROM tbsurat_masuk where kode='$kd_kel' 
													...
													<tr>
														...
														<td class="border text-center">
															<div class="flex sm:justify-center items-center">
																<a class="flex items-center mr-3" href="adm_surat_masuk_detail.php?kd=<?php echo $data['id']?>"> <i data-feather="eye" class="w-4 h-4 mr-1"></i></a>
																<a class="flex items-center mr-3" href="adm_surat_masuk_edit.php?kd=<?php echo $data['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i></a>
																<a class="flex items-center text-theme-6" href="surat_masuk_del.php?kd=<?php echo $data['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i></a>
															</td>															
														</td>								  
													</tr>
												</tbody>
