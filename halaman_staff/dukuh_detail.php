<?php
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nm_dukuh, jumlah_rt, luas, persentase, kode, file_photo, file_name, deskripsi_wilayah 
					FROM tbdukuh where id_dukuh='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
...
<?php include "menu_profil07.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Profil Perdukuhan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-7">
                                        <div class="border border-gray-200 rounded-md p-5">
												<center>
                                                <img class="rounded-md" alt="Peta Batas Perdukuhan" src="<?php echo $file_photo; ?>" width="550px">
												</center>
                                        </div>
                                    </div>											
                                    ...
                                    <div class="col-span-12 xl:col-span-5">
                                        <div class="mt-3">
											...
											placeholder="Input text" value="<?php echo $nm_kel; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Jumlah RT</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $jumlah_rt; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $persentase; ?> %" disabled>
                                        </div>
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-12">
                                        <div>
											<textarea class="input w-full border bg-gray-100 cursor-not-allowed mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" disabled><?php echo $deskripsi_wilayah; ?></textarea>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
