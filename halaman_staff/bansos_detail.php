...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Bantuan Sosial</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" id="txtstatus" name="txtstatus" value="<?php echo $status; ?>" disabled >
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpemberi" name="txtpemberi" value="<?php echo $pemberi; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbentuk" name="txtbentuk" value="<?php echo $bentuk; ?>" disabled>
                                    </div>
									<div class="mt-3">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtkk" name="txtkk" value="<?php echo $kk; ?>" disabled>
                                    </div>
									<div class="mt-3">
										<textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="4"><?php echo $ket; ?></textarea>                                        
                                    </div>
