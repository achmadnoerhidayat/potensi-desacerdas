...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
									kode, tahun, volume, biaya, lokasi, keterangan, nama,
...
<img alt="User Profil" src="<?php echo $file_photo; ?>">
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" action="adm_inventaris_edit_proses.php" method="post">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Isian Table Buku Inventaris Hasil Pembangunan</b></label>
										<input type="text" class="input w-full border mt-2"
										id="txttgl" name="txttgl" placeholder="Tanggal" value="<?php echo $tgl_skr; ?>">
                                    <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" placeholder="Hasil Pembangunan" value="<?php echo $nama; ?>">
                                        <input type="text" class="input w-full border mt-2" 
										id="txtvol" name="txtvol" placeholder="Volume" value="<?php echo $vol; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbiaya" name="txtbiaya" placeholder="Biaya" value="<?php echo $biaya; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtlok" name="txtlok" placeholder="Lokasi" value="<?php echo $lok; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtket" name="txtket" placeholder="Keterangan" value="<?php echo $keterangan; ?>">
                                    </div>
