...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT kd_tumbuhan, luas_tanam, luas_panen, produksi, id, produktivitas FROM tbpertanian where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="perkebunan_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Jenis Tanaman Perkebunan</b></label>
										<select class="input pr-12 w-full border col-span-4" id="cbojenis" name="cbojenis" required>
										<option value=""></option>
										<?php
												$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_tanaman where kelompok='Tanaman Perkebunan'");
									...
									<div class="mt-3">
										<label><b>Luas Areal Tanam (ha)</b></label>
									...
									<div class="mt-3">
										<label><b>Jumlah Produksi Tanam (ton)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
