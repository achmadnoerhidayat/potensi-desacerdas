...
<?php include "menu_rawa.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<a href="" class="">Rawa</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Rawa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="border border-gray-200 rounded-md p-5">
												<center>
                                                <img class="rounded-md" alt="Photo Rawa" src="<?php echo $file_photo; ?>" width="550px">
												</center>
                                        </div>
                                    </div>			
                                    <div class="col-span-12 xl:col-span-6">
                                        <div class="mt-3">
                                            <label>Luas Rawa</label>
