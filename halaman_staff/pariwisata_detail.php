...
<?php include "menu_pariwisata.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Objek Wisata</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-7">
                                        <div class="border border-gray-200 rounded-md p-5">
												<center>
                                                <img class="rounded-md" alt="Photo Objek Wisata" src="<?php echo $file_photo; ?>" width="550px">
												</center>
                                        </div>
                                    </div>											
                                    <div class="col-span-12 xl:col-span-5">
                                        <div class="mt-3">
											...
											placeholder="Input text" value="<?php echo $pengelola; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Jumlah Pengunjung Per Tahun</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo number_format($jml,0) ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Jumlah Pemasukan Per Tahun</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="Rp. <?php echo number_format($pemasukan,0) ?>" disabled>
                                        </div>
									</div>
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-12">
                                        <div>
											<textarea class="input w-full border bg-gray-100 cursor-not-allowed mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" disabled><?php echo $keterangan; ?></textarea>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
