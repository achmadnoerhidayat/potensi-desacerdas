...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Buku Kader Pemberdayaan Masyarakat</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										value="<?php echo $tahun; ?>" autocomplete="off" placeholder="Tahun Anggaran" disabled >
                                    </div>							
								</div>
                            </div>
                        </div>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txttgl" name="txttgl" placeholder="Tanggal" value="<?php echo $tgl_skr; ?>" disabled>
										
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" placeholder="Nama Lengkap" value="<?php echo $nama; ?>" disabled>
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtumur" name="txtumur" placeholder="Umur" value="<?php echo $umur; ?>" disabled>
                                    
                                        <select class="input w-full border mt-2" name="cbojk" id="cbojk" disabled>
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpendidikan" name="txtpendidikan" placeholder="Pendidikan/Kursus" value="<?php echo $pendidikan; ?>" disabled>
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtbidang" name="txtbidang" placeholder="Bidang" value="<?php echo $bidang; ?>" disabled>
										...
										placeholder="Keterangan" disabled><?php echo $keterangan; ?></textarea>
                                    </div>	
