...
<form class="form-horizontal" action="buah_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Jenis Buah-Buahan</b></label>
										<select class="input pr-12 w-full border col-span-4" id="cbojenis" name="cbojenis" required>
										<option value=""></option>
										<?php
												$q = mysqli_query($koneksi,"select kode, nama FROM tbjenis_tanaman where kelompok='Buah'");
