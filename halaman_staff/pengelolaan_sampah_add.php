                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="save_pengelolaan_sampah.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Program">

                                        <input type="text" class="input w-full border mt-2" 
										id="txtdasar" name="txtdasar" autocomplete="off" required placeholder="Dasar Aturan">
										...
										placeholder="Kegiatan Yang dilakukan" required></textarea>

										<textarea class="input w-full border mt-2" id="txthasil" name="txthasil" rows="3" 
										placeholder="Hasil/Manfaat" required></textarea>
                                    </div>
