...
<?php include "menu_profil11.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Input Prestasi Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="save_profil_prestasi.php" method="post">
									...
									<div class="preview">
										<div class="mt-3">
											<div class="relative mt-2">
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Nama Penghargaan" 
										...
										<div class="mt-3">
											<div class="relative mt-2">
												...
												<option value="">Tingkat Penghargaan</option>
													<?php
														$sql="select kode, nama FROM tbtingkat_prestasi";
										...
										<div class="mt-3">
											<div class="relative mt-2">
												...
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="Tanggal Penghargaan" 
												id="txttgl" name="txttgl" value="<?php echo $tgl_skr; ?>" autocomplete="off" required>
											</div>													
										</div>
										<div class="mt-3">
											<div class="relative mt-2">
											<center>
											<button type="submit" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;SIMPAN&nbsp;&nbsp;&nbsp;   
											</button>
											</center>
											</div>											
										</div>
