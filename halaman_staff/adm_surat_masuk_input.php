...
<form class="form-horizontal" action="surat_masuk_input_save.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
                                        ...
                                        <input type="text" class="input w-full border mt-2" 
										id="txtno" name="txtno" placeholder="Nomor" value="">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txttglsrt" name="txttglsrt" placeholder="Tanggal" value="<?php echo $tgl_skr; ?>">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txttujuan" name="txttujuan" placeholder="Tujuan" value="">
                                    
                                        <textarea class="input w-full border mt-2" id="txtisi" name="txtisi" rows="3" 
										placeholder="Isi Singkat" required></textarea>
