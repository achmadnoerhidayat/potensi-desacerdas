...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT nama_wisata, jml_pengunjung, tgl_input, jam_input, user_id, pemasukan, keterangan, pengelola, 
									file_photo FROM tbpariwisata where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama_wisata=$tm_cari['nama_wisata'];
	$jml=$tm_cari['jml_pengunjung'];
	$pemasukan=$tm_cari['pemasukan'];
	$keterangan=$tm_cari['keterangan'];
	$pengelola=$tm_cari['pengelola'];
	$file_photo=$tm_cari['file_photo'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Pariwisata</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Objek Wisata</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="pariwisata_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Nama Objek Wisata</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtnm" name="txtnm" value="<?php echo $nama_wisata; ?>">
                                    </div>	
									
										<div class="mt-3">
											<div class="sm:grid grid-cols-2 gap-2">
												<div class="relative mt-2">
													<label><b>Jumlah Pengunjung per Tahun</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtjml" name="txtjml" value="<?php echo $jml; ?>">
												</div>
												<div class="relative mt-2">
													<label><b>Jumlah Pemasukan per Tahun</b></label>
													<input type="text" class="input pr-12 w-full border col-span-4" 
													id="txtpemasukan" name="txtpemasukan" value="<?php echo $pemasukan; ?>" >
												</div>
											</div>
										</div>

									<div class="mt-3">
										<label><b>Pengelola</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpengelola" name="txtpengelola" value="<?php echo $pengelola; ?>" >
                                    </div>
										
									<div class="mt-3">
																		<label><b>Deskripsi/Daya Tarik Wisata</b></label>
										<textarea class="input w-full border mt-2" id="txtket" name="txtket" rows="4"><?php echo $keterangan; ?></textarea>                                        
                                    </div>

									<div class="mt-3">
	                                    <div>
	                                        <label><b>Upload Foto Objek Wisata</b>
											&nbsp;
