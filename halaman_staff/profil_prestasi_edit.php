...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT 
					kode, nm_penghargaan, kd_tingkat, deskripsi, tanggal, posisi, DATE_FORMAT(tanggal,'%d/%m/%Y') AS tgl 
					FROM tbprestasi WHERE id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nm_penghargaan=$tm_cari['nm_penghargaan'];
	$kd_tingkat=$tm_cari['kd_tingkat'];
	$deskripsi=$tm_cari['deskripsi'];
	$tgl=$tm_cari['tgl'];
	$posisi=$tm_cari['posisi'];
?>
...
<?php include "menu_profil11.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Prestasi Desa</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Prestasi Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
								...
								<form class="form-horizontal" action="profil_prestasi_edit_proses.php" method="post">
									...
									<div class="preview">
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Nama Penghargaan</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="" 
												id="txtnm" name="txtnm" value="<?php echo $nm_penghargaan; ?>">
											</div>													
										</div>	
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Tingkat Penghargaan</b></label>
												<select class="input pr-12 w-full border col-span-4" name="cbokat" id="cbokat" required>
												
													<?php
														$q = mysqli_query($koneksi,"select kode, nama FROM tbtingkat_prestasi");
														while ($row1 = mysqli_fetch_array($q)){
															$k_id           = $row1['kode'];
															$k_opis         = $row1['nama'];
													?>
												<option value='<?php echo $k_id; ?>' <?php if ($k_id == $kd_tingkat){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
													<?php
														}
													?>
												</select>
										...
										<div class="mt-3">
											<div class="relative mt-2">
												<label><b>Tanggal Penghargaan</b></label>
												<input type="text" class="input pr-12 w-full border col-span-4" placeholder="" 
												id="txttgl" name="txttgl" value="<?php echo $tgl; ?>" >
											</div>													
										</div>
										<div class="mt-3">
											<div class="relative mt-2">
											<center>
											<button type="submit" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;UPDATE&nbsp;&nbsp;&nbsp;   
											</button>
											</center>
											</div>											
										</div>
