...
<?php include "menu_mataair.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Mata Air</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="col-span-12 xl:col-span-6">
                                        ...
                                        <div class="mt-3">
                                            <label>Volume</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $kedalaman; ?> m3" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Kondisi Mata Air</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
