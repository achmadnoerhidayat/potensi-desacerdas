						...
						<table class="table table--sm" width="100%"> 
							<tr> 
								...
								<td class="border text-center whitespace-no-wrap" bgcolor="white" width="33%">
									<font color="black">Wewenang/Tugas</font>
								</td>
...
<form class="form-horizontal" action="lembaga_input02.php" method="post">
                        ...
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                ...
                                <div class="preview">
									...
									<div class="mt-3">
										<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="6" 
										placeholder="Deskripsi Wewenang/Tugas" required></textarea>                                        
                                    </div>
