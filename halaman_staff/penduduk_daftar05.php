...
<?php include "menu_penduduk02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Data Kependudukan Berdasarkan Pekerjaan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <div class="intro-y box p-5">
								...
								<?php echo $jml_penduduk; ?> jiwa</b>
                                                    	...
                                                    	<td width="10%" class="no-border text-center">
															...
															<a href="report05.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Download&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a target="_blank" href="export_excel05.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export Excel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a href="cetak05.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                </tr>
                                            </tbody>
...
<table class="table"> 
											<thead> 
												<tr> 
													...
													<th class="border border-b-2 whitespace-no-wrap" style="background-color: yellow;"><font size="2"><b>Pekerjaan</b></font></th>
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													where kode='$kd_kel' and kd_pekerjaan='$txtcari'");
													} else {
												...
												if(isset($_POST['tambah'])){	
													...
													where kode='$kd_kel' and kd_pekerjaan='$txtcari' order by kd_pekerjaan LIMIT $mulai, $halaman")or die(mysql_error);
												} else {
													$query = mysqli_query($koneksi,"select *, DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tanggal from tbpenduduk 
													where kode='$kd_kel' order by kd_pekerjaan LIMIT $mulai, $halaman")or die(mysql_error);
												}
												$no =$mulai+1;
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border text-center" bgcolor="yellow"><font size="2"><?php echo $pekerjaan; ?></font></td>
														<td class="border">
															<form action="penduduk_detail01.php" method="post">			
																<input type="hidden" name="txtid" value="<?php echo $data['id']; ?>"/>															
																<input type="hidden" name="txtform" value="5"/>
														...
														<td class="border">
																<a href="penduduk_del.php?txtid=<?php echo $data['id']?>&txtform=5" 
