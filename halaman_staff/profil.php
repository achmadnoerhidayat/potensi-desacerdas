...
<?php include "menu_profil01.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Informasi Umum Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" enctype="multipart/form-data" action="profil_edit_proses.php" method="post">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Gambar Peta Lokasi Desa</b>&nbsp;<?php echo $file_peta; ?></label>
									...
									<div class="mt-3">
										...
										id="txtkdpos" name="txtkdpos" value="<?php echo $kd_pos; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>	
									<div class="mt-3">
										<label><b>Kode Kemendagri</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" value="<?php echo $kd_kel; ?>" disabled>
                                    </div>
									<div class="mt-3">
									...
									<div class="mt-3">
										<label><b>Jumlah Penduduk</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtjmlp" name="txtjmlp" value="<?php echo $jmlp; ?>" 
										autocomplete="off" required placeholder="Jumlah Penduduk">
                                    </div>
									<div class="mt-3">
										<label><b>Kepadatan (Jiwa/km)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpadat" name="txtpadat" value="<?php echo $padat; ?>" 
										autocomplete="off" required placeholder="Kepadatan (Jiwa/km)">
                                    </div>
