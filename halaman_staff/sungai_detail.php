...
<?php include "menu_sungai.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Sungai</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="col-span-12 xl:col-span-5">
                                        <div class="mt-3">
											...
											placeholder="Input text" value="<?php echo $p; ?> km" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Lebar Sungai</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $l; ?> meter" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Kedalaman Sungai</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $kedalaman; ?> meter" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Debit Air Sungai</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $debit; ?> m3/detik" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Kondisi Sungai</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $kondisi; ?>" disabled>
                                        </div>
									</div>
