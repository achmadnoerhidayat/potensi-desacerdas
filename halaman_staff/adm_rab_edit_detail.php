...
session_start();
	...
	$id = $_GET['id'];
	$cari_kd=mysqli_query($koneksi,"SELECT tahun, bidang, bidang_sub, kegiatan, waktu, rincian from tbrab 
									where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$tahun=$tm_cari['tahun'];
	...
	if(isset($_POST['btntutupsub'])) {
		$next = 'location:adm_rab_edit.php?kd=';
		$awal = $next.$id;
		header($awal);
	}
	...
	if(isset($_POST['btndetail'])) {
		...
		mysqli_query($koneksi,"INSERT INTO tbrab_detail (kode_rab, uraian, volume, harga, jumlah, no_anggaran) 
								VALUES 
								('$txtid','$txturaian','$txtvol','$txtharga','$txtjml','$cbosub')");
	}	
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Edit Rencana Anggaran Biaya</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										...
										disabled value="<?php echo $tahun; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtbidang" name="txtbidang" 
										disabled value="<?php echo $bidang; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtbidangsub" name="txtbidangsub" 
										disabled value="<?php echo $bidang_sub; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtkeg" name="txtkeg" 
										disabled value="<?php echo $kegiatan; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtwaktu" name="txtwaktu" 
										disabled value="<?php echo $waktu; ?>" >
                                    
                                        <input type="text" class="input w-full border mt-2" id="txtrincian" name="txtrincian" 
										disabled value="<?php echo $rincian; ?>" >
                                    </div>	
								</div>
                            </div>
                        </div>
...
<br>
                        <div class="intro-y box">
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
										<label><b>Isian Table Rencana Anggaran Biaya</b></label>
                                    </div>
									<div class="mt-3">
										<select class="input pr-12 w-full border col-span-4" name="cbosub" id="cbosub">
										<?php
											$sql="select no_anggaran, uraian_sub FROM tbrab_sub where kode_rab='$id'";
											$sql_row=mysqli_query($koneksi,$sql);
											while($sql_res=mysqli_fetch_assoc($sql_row))	
												{
										?>
										<option value="<?php echo $sql_res["no_anggaran"]; ?>"><?php echo $sql_res["uraian_sub"]; ?></option>
										<?php
											}
										?>								
										</select>
										...
										id="txturaian" name="txturaian" placeholder="Uraian">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtvol" name="txtvol" placeholder="Volume">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtharga" name="txtharga" placeholder="Harga Satuan">
                                    
                                        <input type="text" class="input w-full border mt-2" 
										id="txtjml" name="txtjml" placeholder="Jumlah">
									</div>
									<div class="mt-3">
										<div class="relative mt-2 text-right">
											<button type="submit" name="btndetail" class="button text-white bg-theme-1 shadow-md mr-2">+ Tambahkan</button>
										</div>
									</div>
								</div>
								<br>
									<table class="table table--sm" width="100%"> 
										<thead> 
											<tr> 														
												<th rowspan="2" class="border text-center whitespace-no-wrap"><font size="2"><b>No</b></font></th>
												<th rowspan="2" class="border whitespace-no-wrap"><font size="2"><b>Uraian</b></font></th>
												<th colspan="3" class="border text-center whitespace-no-wrap"><font size="2"><b>Anggaran</b></font></th>
												<th rowspan="2" class="border text-center whitespace-no-wrap"><font size="2"><b>Aksi</b></font></td>	
											</tr> 
											<tr> 											
												<th class="border text-center whitespace-no-wrap"><font size="2"><b>Volume</b></font></th>
												<th class="border text-center whitespace-no-wrap"><font size="2"><b>Harga SATUAN</b></font></th>
												<th class="border text-center whitespace-no-wrap"><font size="2"><b>Jumlah</b></font></td>	
											</tr>
										</thead>
										...
										<tbody>
											<tr>
												<td class="border text-center"><b><?php echo $tampil['no_anggaran']; ?></b></td>    
												<td class="border"><b><?php echo $tampil['uraian_sub']; ?></b></td>    
												<td class="border text-center"></td>
												<td class="border text-center"></td>
												<td class="border text-center"><b><?php echo number_format($tot_rab_sub,2); ?></b></td>    
												<td class="border text-center"></td>								  
											</tr>
											
										<?php 
											$no = 0 ;
											$sql1 = mysqli_query($koneksi,"SELECT * from tbrab_detail where kode_rab='$id' 
																			and no_anggaran='$no_anggaran' order by id");
										...
										?>
											...
											<tr>
												<td class="border text-center"></td>    
												<td class="border"><?php echo $tampil1['uraian']; ?></td>    
												<td class="border text-center"><?php echo $tampil1['volume']; ?></td>
												<td class="border text-center"><?php echo number_format($tampil1['harga'],2); ?></td>
												<td class="border text-center"><?php echo number_format($tampil1['jumlah'],2); ?></td>    
												<td class="border text-center">
													<div class="flex sm:justify-center items-center">
														<a class="flex items-center mr-3" href="adm_rab_edit_detail1.php?kd=<?php echo $tampil1['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i></a>
														<a class="flex items-center text-theme-6" href="adm_rab_del_detail.php?kd=<?php echo $tampil1['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i></a>
													</div>															
												</td>								  												
											</tr>								
										</tbody>
...
<div class="mt-3 center">
										<center>
											<button type="submit" name="btntutupsub" class="button bg-theme-1 text-white mt-5">   &nbsp;&nbsp;&nbsp;TUTUP&nbsp;&nbsp;&nbsp;   </button>
										</center>
                                    </div>
<br>
