...
<?php include "menu_bansos02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Daftar Penerima Bansos</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<div class="text-xs text-theme-41"><?php include "titel_status.php"; ?></div>
											...
											<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
												<tr class="">
													<td width="25%" class="no-border">
														<select class="input pr-12 w-full border col-span-4" name="cbodukuh" id="cbodukuh">
										...
										<table class="table table--sm" width="100%"> 
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													if($cbodukuh<>'') {
														$result = mysqli_query($koneksi,"SELECT tbbansos_penerima.kd_bansos, tbbansos_penerima.nik, 
														tbpenduduk.nama,tbpenduduk.id_dukuh,tbpenduduk.rt, tbbansos_penerima.id 
														FROM tbbansos_penerima, tbpenduduk 
														WHERE tbbansos_penerima.nik=tbpenduduk.nik and tbbansos_penerima.kd_bansos='$id' and 
														tbpenduduk.id_dukuh='$cbodukuh'");														
													} else {
														$result = mysqli_query($koneksi,"SELECT tbbansos_penerima.kd_bansos, tbbansos_penerima.nik, 
														tbpenduduk.nama,tbpenduduk.id_dukuh,tbpenduduk.rt, tbbansos_penerima.id 
														FROM tbbansos_penerima, tbpenduduk 
														WHERE tbbansos_penerima.nik=tbpenduduk.nik and tbbansos_penerima.kd_bansos='$id'");														
													}
	...
	$id = $_POST['txtid'];													
													if($cbodukuh<>'') {
														$query = mysqli_query($koneksi,"SELECT tbbansos_penerima.kd_bansos, tbbansos_penerima.nik, 
														tbpenduduk.nama,tbpenduduk.id_dukuh,tbpenduduk.rt, tbbansos_penerima.id 
														FROM tbbansos_penerima, tbpenduduk 
														WHERE tbbansos_penerima.nik=tbpenduduk.nik and tbbansos_penerima.kd_bansos='$id' 
														and 
														tbpenduduk.id_dukuh='$cbodukuh' LIMIT $mulai, $halaman")or die(mysql_error);														
													} else {
														$query = mysqli_query($koneksi,"SELECT tbbansos_penerima.kd_bansos, tbbansos_penerima.nik, 
														tbpenduduk.nama,tbpenduduk.id_dukuh,tbpenduduk.rt, tbbansos_penerima.id 
														FROM tbbansos_penerima, tbpenduduk 
