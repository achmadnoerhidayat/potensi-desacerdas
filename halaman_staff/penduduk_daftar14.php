...
<?php include "menu_penduduk02.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Data Penduduk Sementara</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
                                                ...
                                                <tr valign="top" class="">
                                                    	...
                                                    	<td width="10%" class="no-border text-center">
															...
															<a href="report14.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Download&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a target="_blank" href="export_excel14.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Export Excel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                    	<td width="10%" class="no-border text-center">
															<button type="button" class="button w-40 bg-theme-1 text-white">
															<a href="cetak14.php" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Print&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
															</button>
														</td>
                                                </tr>
                                            </tbody>
...
<table class="table"> 
											<thead> 
												<tr> 
													...
													<td colspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>JENIS KELAMIN</b></font></center></td> 													
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>NOMOR IDENTITAS/TANDA PENGENAL</b></font></center></td> 
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>TEMPAT DAN TANGGAL LAHIR</b></font></center></td> 
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>PEKERJAAN</b></font></center></td>
													<td colspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>KEWARGANEGARAAN</b></font></center></td>
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>DATANG DARI</b></font></center></td> 
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>MAKSUD DAN TUJUAN</b></font></center></td>
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>NAMA DAN ALAMAT YANG DIDATANGI</b></font></center></td>
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>DATANG TANGGAL</b></font></center></td>
													<td rowspan="2" class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>PERGI TANGGAL</b></font></center></td>
												...
												<tr> 
													...
													<td class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>KEBANGSAAN</b></font></center></td> 
													<td class="border border-b-2 whitespace-no-wrap"><center><font size="2"><b>KETURUNAN</b></font></center></td> 
												</tr> 
											</thead>  
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													menetap='Datang Dari' and (nama like '%$txtcari%' or nik like '%$txtcari%' or kk like '%$txtcari%')");
													} else {
													$result = mysqli_query($koneksi,"SELECT * FROM tbpenduduk where kode='$kd_kel' and menetap='Datang Dari'");
												}
												...
												if(isset($_POST['tambah'])){	
													...
													from tbpenduduk 
													where kode='$kd_kel' and menetap='Datang Dari' and (nama like '%$txtcari%' or nik like '%$txtcari%' or kk like '%$txtcari%')
													...
													DATE_FORMAT(tgl_pergi,'%d/%m/%Y') AS tanggal_pergi 
													from tbpenduduk 
													where kode='$kd_kel' and menetap='Datang Dari' LIMIT $mulai, $halaman")or die(mysql_error);
												}
												$no =$mulai+1;
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border text-center"><font size="2"><?php echo $data['maksud_datang']; ?></font></td>														
														<td class="border text-center"><font size="2"><?php echo $data['didatangi']; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $data['tanggal_datang']; ?></font></td>
														<td class="border text-center"><font size="2"><?php echo $data['tanggal_pergi']; ?></font></td>														
														<td class="border text-center"><font size="2"><?php echo $data['keterangan']; ?></font></td>
			<td class="border">
															<form action="penduduk_detail01.php" method="post">			
																<input type="hidden" name="txtid" value="<?php echo $data['id']; ?>"/>															
																<input type="hidden" name="txtform" value="14"/>
														...
														<td class="border">
																<a href="penduduk_del.php?txtid=<?php echo $data['id']?>&txtform=14" 
