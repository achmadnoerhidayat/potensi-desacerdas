<?php
	...
	$id=$_POST['txtid'];
	$cari_kd=mysqli_query($koneksi,"SELECT nama, id_jk, tempat_lhr, 
									DATE_FORMAT(tgl_lhr,'%d/%m/%Y') AS tgl_lhr1, id_agama, nap, nip, 
									id_jabatan, pangkat, no_pengangkatan, 
									DATE_FORMAT(tgl_pengangkatan,'%d/%m/%Y') AS tgl_pengangkatan1, 
									no_berhenti, 
									DATE_FORMAT(tgl_berhenti,'%d/%m/%Y') AS tgl_berhenti1, keterangan, kd_pendidikan, 
									file_photo, file_name 
									FROM tbperangkat WHERE id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$nama=$tm_cari['nama'];
	$id_jk=$tm_cari['id_jk'];
	...
	$nap=$tm_cari['nap'];
	$nip=$tm_cari['nip'];
	$tgl_lhr=$tm_cari['tgl_lhr1'];
	$id_jabatan=$tm_cari['id_jabatan'];
	$pangkat=$tm_cari['pangkat'];
	$no_pengangkatan=$tm_cari['no_pengangkatan'];
	$no_berhenti=$tm_cari['no_berhenti'];
	$keterangan=$tm_cari['keterangan'];
	$kd_pendidikan=$tm_cari['kd_pendidikan'];
	$tgl_pengangkatan=$tm_cari['tgl_pengangkatan1'];
	$tgl_berhenti=$tm_cari['tgl_berhenti1'];
	...
	$cari_kd=mysqli_query($koneksi,"select agama FROM tbagama WHERE kode='$id_jk'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$agama=$tm_cari['agama'];
	...
	$cari_kd=mysqli_query($koneksi,"select pendidikan FROM tbpendidikan WHERE kode='$id_jk'");
	$tm_cari=mysqli_fetch_array($cari_kd);
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Perangkat Desa</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
                            <div class="dropdown-box__content box bg-theme-38 text-white">
                                <div class="p-4 border-b border-theme-40">
                                    ...
                                    <div class="text-xs text-theme-41">Staff Desa</div>
                                </div>
                                <div class="p-2">
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    ...
                                    <div class="col-span-12 xl:col-span-8">
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" placeholder="Input text" value="<?php echo $nama; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>NAP</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" placeholder="Input text" value="<?php echo $nap; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>NIP</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" placeholder="Input text" value="<?php echo $nip; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Jabatan</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" placeholder="Input text" value="<?php echo $jabatan; ?>" disabled>
                                        </div>
									</div>
                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            ...
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" placeholder="Input text" value="<?php echo $tempat_lhr; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Jenis Kelamin</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $jk; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Pangkat Golongan</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $pangkat; ?>" disabled>
                                        </div>   
										<div class="mt-3">
                                            <label>Nomor</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $no_pengangkatan; ?>" disabled>
                                        </div> 										
										<div class="mt-3">
                                            <label>Nomor</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $no_berhenti; ?>" disabled>
                                        </div> 										
                                    </div>
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                            <label>Tanggal Lahir</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $tgl_lhr; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Agama</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $agama; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Pendidikan</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $pendidikan; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Tanggal Putusan Pengangkatan</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $tgl_pengangkatan; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Tanggal Putusan Pemberhentian</label>
                                            <input type="text" class="input w-full border mt-2" placeholder="Input text" value="<?php echo $tgl_berhenti; ?>" disabled>
                                        </div>
                                    </div>
                                </div>
