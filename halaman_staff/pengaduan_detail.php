...
$id=$_POST['txtid'];
	$cari_kd=mysqli_query($koneksi,"SELECT 
					...
					tbpengaduan.isi, tbpengaduan.balasan  
...
<?php include "menu_pengaduan02.php"; ?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Detail Pengaduan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    ...
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									<div class="mt-3">
                                        <textarea class="input w-full border mt-2" name="comment" disabled><?php echo $balasan; ?></textarea>
                                    </div>							
                                </div>
                            </div>
                        </div>
