...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT id_sumber, vol, berat FROM tbtimbulan where id='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
	$id_sumber=$tm_cari['id_sumber'];
	$vol=$tm_cari['vol'];
	$berat=$tm_cari['berat'];
?>
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="">Timbulan Sampah</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y box">
							...
							<form class="form-horizontal" action="sampah_timbulan_edit_proses.php" method="post">
<input type="hidden" name="txtid" value="<?php echo $id; ?>"/>
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										<label><b>Sumber Sampah</b></label>
										<select class="input pr-12 w-full border col-span-4" name="cbojns" id="cbojns" required>
										
										<?php
													$q = mysqli_query($koneksi,"select id, sumber FROM tbtimbulan_sumber");
													while ($row1 = mysqli_fetch_array($q)){
														$k_id           = $row1['id'];
														$k_opis         = $row1['sumber'];
												?>
												<option value='<?php echo $k_id; ?>' <?php if ($k_id == $id_sumber){ echo 'selected'; } ?>><?php echo $k_opis; ?></option>
												<?php
													}
												?>
										</select>
									...
									<div class="mt-3">
										<label><b>Volume (liter/orang/hari)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt1" name="txt1" value="<?php echo $vol; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>	
									<div class="mt-3">
										<label><b>Berat (kg/orang/hari)</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txt2" name="txt2" value="<?php echo $berat; ?>" 
										autocomplete="off" required placeholder="">
                                    </div>
