											...
											<form action="" name="modal_popup" enctype="multipart/form-data" method="POST">
												<tr class="">
													<td width="50%" class="no-border">
														...
														placeholder="Cari Nama Dukuh/Dusun" id="txtcari" name="txtcari">
													</td>
										...
										<table class="table table--sm" width="100%"> 
											...
											<?php 
												...
												if(isset($_POST['tambah'])){	
													...
													if ($txtcari<>'') {
														$result = mysqli_query($koneksi,"SELECT * FROM tbdukuh where kode='$kd_kel' and nm_dukuh like '%$txtcari%'");
													}
													if ($txtcari=='') {
														$result = mysqli_query($koneksi,"SELECT * FROM tbdukuh where kode='$kd_kel'");
													}	
												} else {
													$result = mysqli_query($koneksi,"SELECT * FROM tbdukuh where kode='$kd_kel'");
												}
												...
												if(isset($_POST['tambah'])){	
													$txtcari = $_POST['txtcari'];
													if ($txtcari<>'') {
														$query = mysqli_query($koneksi,"SELECT * FROM tbdukuh where kode='$kd_kel' and nm_dukuh like '%$txtcari%' LIMIT $mulai, $halaman")or die(mysql_error);													
													}
													if ($txtcari=='') {
														$query = mysqli_query($koneksi,"SELECT * FROM tbdukuh where kode='$kd_kel' LIMIT $mulai, $halaman")or die(mysql_error);
													}
												} else {
													$query = mysqli_query($koneksi,"select * FROM tbdukuh where kode='$kd_kel' LIMIT $mulai, $halaman")or die(mysql_error);
												}
