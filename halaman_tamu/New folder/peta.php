...
session_start();
	...
	$peta_wilayah=$tm_cari['peta_wilayah'];
	$peta_dukuh=$tm_cari['peta_dukuh'];
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="" class="breadcrumb--active">Peta Wilayah dan Peta Batas Perdukuhan</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                ...
                <!-- END: Top Bar -->
											...
											<form class="form-horizontal" enctype="multipart/form-data" action="peta1_proses.php" method="post">
											<input type="hidden" name="txtid" value="<?php echo $kd_kel; ?>"/>
												<div class="mt-3">
													<label><b>Upload Gambar Peta Wilayah</b>&nbsp;
													<a href="javascript:void(0);" onClick="newPopup('peta_detail.php?img=<?php echo $peta_wilayah; ?>');"><?php echo $peta_wilayah; ?></a>
													</label>
												</div>
											...
											<form class="form-horizontal" enctype="multipart/form-data" action="peta2_proses.php" method="post">
											<input type="hidden" name="txtid" value="<?php echo $kd_kel; ?>"/>
												<div class="mt-3">
													<label><b>Upload Gambar Peta Batas Perdukuhan</b>&nbsp;
																										<a href="javascript:void(0);" onClick="newPopup('peta_detail.php?img=<?php echo $peta_dukuh; ?>');"><?php echo $peta_dukuh; ?></a>
													</label>
													<input type="file" id="gambar1" name="gambar1" class="input w-full border mt-2" />
...
uploadField.onchange = function() {
    if(this.files[0].size > 5000000){ // ini untuk ukuran 800KB, 1000000 untuk 1 MB.
       ...
       this.value = "";
		...
		<script type="text/javascript">
var uploadField = document.getElementById("gambar1");
uploadField.onchange = function() {
    if(this.files[0].size > 5000000){ // ini untuk ukuran 800KB, 1000000 untuk 1 MB.
       alert("Maaf. File Terlalu Besar ! Maksimal Upload 5 Mb");
       this.value = "";
