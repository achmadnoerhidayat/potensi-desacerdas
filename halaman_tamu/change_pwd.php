...
session_start();
	...
	$cari_kd=mysqli_query($koneksi,"SELECT password FROM tbuser WHERE nip='$nip'");
	$tm_cari=mysqli_fetch_array($cari_kd);
...
<?php include "menu_dashboard.php"; ?>
            ...
            <div class="content">
                ...
                <div class="top-bar">
					...
					<a href="#" class="breadcrumb--active">Change Password</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                            ...
                            <div class="p-5" id="input">
                                <div class="preview">
									...
									<div class="mt-3">
										...
										id="txtpasslama" name="txtpasslama" value="<?php echo $password; ?>" disabled >
                                    </div>	
									<div class="mt-3">
										<label><b>Password Baru</b></label>
                                        <input type="text" class="input w-full border mt-2" 
										id="txtpassbaru" name="txtpassbaru" required autocomplete="off">
                                    </div>
