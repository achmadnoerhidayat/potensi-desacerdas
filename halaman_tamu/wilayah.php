...
<input type="hidden" name="txtkd_kel" value="<?php echo $kd_kel; ?>"/>
											...
											<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" placeholder="Deskripsi" disabled ><?php echo $deskripsiw; ?></textarea>
						                                    </div>
						                                </div>
						                            </div>
						                        </div>  
										...
										<table class="table table--sm" width="100%"> 
											<thead> 
												<tr> 
													...
													<th class="border text-center whitespace-no-wrap">Jumlah RT</th>
											...
											?>
												<tbody>
													<tr>
														...
														<td class="border text-center"><?php echo $data['jumlah_rt']; ?></td>            
														<td class="border text-center"><?php echo $data['luas']; ?></td> 
