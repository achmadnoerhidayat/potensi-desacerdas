                                ...
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-7">
                                        <div class="border border-gray-200 rounded-md p-5">
												<center>
                                                <img class="rounded-md" alt="Peta Batas Perdukuhan" src="<?php echo $file_peta; ?>" width="550px">
												</center>
                                        </div>
                                    </div>											
                                    <div class="col-span-12 xl:col-span-5">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $kd_pos; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Kode Kemendagri</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $kd_kel; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $jmlp; ?>" disabled>
                                        </div>
                                        <div class="mt-3">
                                            <label>Kepadatan</label>
                                            <input type="text" class="input w-full border bg-gray-100 cursor-not-allowed mt-2" 
											placeholder="Input text" value="<?php echo $padat; ?> Jiwa/km" disabled>
                                        </div>
									</div>
