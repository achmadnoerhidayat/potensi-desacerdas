...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="#" class="breadcrumb--active">Update Informasi Covid 19</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    ...
                    <div class="intro-x dropdown w-8 h-8 relative">
                        ...
                        <div class="dropdown-box mt-10 absolute w-56 top-0 right-0 z-20">
                            <div class="dropdown-box__content box bg-theme-38 text-white">
                                ...
                                <div class="p-2">
                                    <a href="profil.php" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
			...
			<a href="covid_update_add.php">Tambah Data</a></button>
                    </div>                    
                </div>
                <!-- BEGIN: Datatable -->
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b-2 text-center whitespace-no-wrap">Suspect</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Probable</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Positif</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Perawatan</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Meninggal</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Sembuh</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">OTG</th>
                                <th class="border-b-2 text-center whitespace-no-wrap">Isoman</th>
                        ...
                        <tbody>
							...
							<?php 
								...
								$sql = mysqli_query($koneksi,"SELECT 
									...
									suspect, probable, positif, perawatan, meninggal, sembuh, otg, isoman, id 
									FROM tbcovid where kode='$kd_kel'");
								while ($tampil = mysqli_fetch_array($sql)) {
									$no++;
							?>
							
                            <tr>
                                <td class="border-b text-center"><?php echo $tampil['tanggal']?></td>
                                <td class="border-b text-center"><?php echo $tampil['suspect']?></td>
                                <td class="border-b text-center"><?php echo $tampil['probable']?></td>
                                <td class="border-b text-center"><?php echo $tampil['positif']?></td>
                                <td class="border-b text-center"><?php echo $tampil['perawatan']?></td>
                                <td class="border-b text-center"><?php echo $tampil['meninggal']?></td>
                                <td class="border-b text-center"><?php echo $tampil['sembuh']?></td>
                                <td class="border-b text-center"><?php echo $tampil['otg']?></td>
                                <td class="border-b text-center"><?php echo $tampil['isoman']?></td>
                                <td class="border-b text-center">
                                    <div class="flex sm:justify-center items-center">
                                        <a class="flex items-center mr-3" href="covid_update_edit.php?kd=<?php echo $tampil['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-theme-6" href="covid_update_del.php?kd=<?php echo $tampil['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
				</td>
                            </tr>
