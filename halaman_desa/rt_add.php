...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_wilayah_rt.php" method="post">
						                            ...
						                            <div class="p-5">
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																...
																<div class="mt-3">
																	<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" placeholder="Deskripsi" required></textarea>
						                                        </div>
						                                    </div>
						                                </div>
						                            </div>
						                                ...
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																...
																<div class="mt-3">
																	...
																	id="txtkk" name="txtkk" autocomplete="off" required placeholder="Masukkan Jumlah KK">
						                                        </div>
																<div class="mt-3">
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtjiwa" name="txtjiwa" autocomplete="off" required placeholder="Masukkan Jumlah Jiwa">
						                                        </div>
																<div class="mt-3">
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtluas" name="txtluas" autocomplete="off" required placeholder="Luas Wilayah (ha)">
						                                        </div>
																<div class="mt-3">
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtpersen" name="txtpersen" autocomplete="off" required placeholder="Persentase Wilayah %">
						                                        </div>	
																<div class="mt-3">
																	<div class="sm:grid grid-cols-2 gap-2">
																		...
																		<div class="relative mt-2">
																			<button class="button text-white bg-theme-1 shadow-md mr-2">
																				<a href="tambah_rt.php">Tambah Data RT</a>
																			</button>																			
																		</div>
																	</div>
						                                        </div>
