...
session_start();
	...
	$id=$_GET['kd'];
	$cari_kd=mysqli_query($koneksi,"SELECT id_dukuh, deskripsi, rt, kk, jiwa, luas, persentase FROM tbrt WHERE id_rt='$id'");
	$tm_cari=mysqli_fetch_array($cari_kd);
...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
					...
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
					<a href="rt.php" class="">Luas Wilayah dan Jumlah Penduduk Tiap RT</a>
					<i data-feather="chevron-right" class="breadcrumb__icon"></i>
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="wilayah_rt_edit_proses.php" method="post">
						                                ...
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																<div class="mt-3">
																	...
																	id="txtdukuh" name="txtdukuh" value="<?php echo $nm_dukuh; ?>" disabled>
															
						                                        </div>
																<div class="mt-3">
																	<label><b>Deskripsi</b></label>
																	<textarea class="input w-full border mt-2" id="txtdeskripsi" name="txtdeskripsi" rows="3" placeholder="Deskripsi" required><?php echo $deskripsi; ?></textarea>
						                                        </div>
						                                    </div>
						                                </div>
						                            </div>
						                                ...
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																<div class="mt-3">
																	<label><b>RT</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtrt" name="txtrt" value="<?php echo $rt; ?>" disabled>
						                                        </div>
																<div class="mt-3">
																	<label><b>Masukkan Jumlah KK</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtkk" name="txtkk" value="<?php echo $kk; ?>" 
																	autocomplete="off" required placeholder="Masukkan Jumlah KK">
						                                        </div>
																<div class="mt-3">
																	<label><b>Masukkan Jumlah Jiwa</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtjiwa" name="txtjiwa" value="<?php echo $jiwa; ?>" 
																	autocomplete="off" required placeholder="Masukkan Jumlah Jiwa">
						                                        </div>
																<div class="mt-3">
																	<label><b>Luas Wilayah (ha)</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtluas" name="txtluas" value="<?php echo $luas; ?>" 
																	autocomplete="off" required placeholder="Luas Wilayah (ha)">
						                                        </div>
																<div class="mt-3">
																	<label><b>Persentase Wilayah %</b></label>
                                        							<input type="text" class="input w-full border mt-2" 
																	id="txtpersen" name="txtpersen" value="<?php echo $persentase; ?>" 
																	autocomplete="off" required placeholder="Persentase Wilayah %">
						                                        </div>	
