...
<div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="index.php" class="">Home</a> 
                ...
                <!-- END: Top Bar -->
								...
								<form class="form-horizontal" enctype="multipart/form-data" action="save_pengurus.php" method="post">
						                                ...
						                                <div class="grid grid-cols-12 gap-5">
						                                    <div class="col-span-12 xl:col-span-12">
																...
																<div class="mt-3">
																	...
																	id="txtnm" name="txtnm" autocomplete="off" required placeholder="Nama Pengurus RT">
						                                        </div>
																<div class="mt-3">
																	<div>
																		<label><b>Upload Foto Pengurus RT</b></label>
																...
																<div class="mt-3">
																	...
																	<?php
																		$sql="select kode, jabatan FROM tbjabatan_pengurus";
			       														$sql_row=mysqli_query($koneksi,$sql);
			       														while($sql_res=mysqli_fetch_assoc($sql_row))	
																		{
																	?>
