                    ...
                    <table class="table table-report table-report--bordered display datatable w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b-2 whitespace-no-wrap">Nama Lembaga</th>
                        ...
                        <tbody>
							...
							<?php 
								...
								$sql = mysqli_query($koneksi,"SELECT 
									id, kode, nm_lembaga, kd_kategori, deskripsi, wewenang, 
									nm_pengurus, kd_jabatan, mulai, sampai, file_photo 
									FROM tblembaga where kode='$kd_kel'");
								while ($tampil = mysqli_fetch_array($sql)) {
									$no++;
																$kd_kategori=$tampil['kd_kategori'];
                            ...
                            <tr>
                                <td class="border-b text-center"><?php echo $no ?></td>
                                <td class="border-b"><?php echo $tampil['nm_lembaga']?></td>
                                <td class="border-b text-center"><?php echo $nm_kategori;?></td>
                                <td class="border-b text-center">
					<form action="lembaga_detail.php" method="post">			
						<input type="hidden" name="txtid" value="<?php echo $tampil['id']; ?>"/>															
						<button class="btn_style" type="submit">Detail</button>
					</form>
				</td>
                                <td class="border-b text-center">
                                    <div class="flex sm:justify-center items-center">
                                        <a class="flex items-center mr-3" href="program_edit.php?kd=<?php echo $tampil['id']?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                        <a class="flex items-center text-theme-6" href="lembaga_del.php?kd=<?php echo $tampil['id']?>" onclick="return confirm('Data akan dihapus. Lanjutkan?')"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
				</td>
                            </tr>
